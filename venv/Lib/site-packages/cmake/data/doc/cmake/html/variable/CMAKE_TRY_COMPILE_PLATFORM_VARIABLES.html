...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_TRY_COMPILE_PLATFORM_VARIABLES &mdash; CMake 3.21.0 Documentation</title>
...
<p>List of variables that the <span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command source file signature
...
propagated automatically.  The <code class="docutils literal notranslate"><span class="pre">CMAKE_TRY_COMPILE_PLATFORM_VARIABLES</span></code>
variable may be set to pass custom variables meaningful to a toolchain file.
For example, a toolchain file may contain:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set(</span><span class="no">CMAKE_SYSTEM_NAME</span><span class="w"> </span><span class="p">...</span><span class="nf">)</span><span class="w"></span>
<span class="nf">set(</span><span class="no">CMAKE_TRY_COMPILE_PLATFORM_VARIABLES</span><span class="w"> </span><span class="no">MY_CUSTOM_VARIABLE</span><span class="nf">)</span><span class="w"></span>
<span class="c"># ... use MY_CUSTOM_VARIABLE ...</span>
</pre></div>
</div>
<p>If a user passes <code class="docutils literal notranslate"><span class="pre">-DMY_CUSTOM_VARIABLE=SomeValue</span></code> to CMake then this
setting will be made visible to the toolchain file both for the main
project and for test projects generated by the <span class="target" id="index-1-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a>
