...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckCXXSourceRuns &mdash; CMake 3.21.0 Documentation</title>
...
<p>Check if given C++ source compiles and links into an executable and can
subsequently be run.</p>
<dl class="command">
<dt id="command:check_cxx_source_runs">
<code class="sig-name descname">check_cxx_source_runs</code><a class="headerlink" href="#command:check_cxx_source_runs" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_cxx_source_runs(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_cxx_source_runs()</span></code>:</p>
<dl>
