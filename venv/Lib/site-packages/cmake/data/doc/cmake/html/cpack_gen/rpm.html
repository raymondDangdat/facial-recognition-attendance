...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack RPM Generator &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpack-rpm-generator">
<span id="cpack_gen:CPack RPM Generator"></span><h1>CPack RPM Generator<a class="headerlink" href="#cpack-rpm-generator" title="Permalink to this headline">¶</a></h1>
...
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_XXX</span></code> variables.</p>
<p><code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_XXXX</span></code> variables may be used in order to have
...
component is named <code class="docutils literal notranslate"><span class="pre">foo</span></code> then use <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_FOO_XXXX</span></code> variable name format)
as is with other <code class="docutils literal notranslate"><span class="pre">CPACK_&lt;COMPONENT&gt;_XXXX</span></code> variables.
...
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_fOo_XXXX</span></code>) is still supported for variables defined in older
...
<p><span class="versionmodified added">New in version 3.2: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;component&gt;_PACKAGE_SUMMARY</span></code> variables.</p>
</div>
</dd></dl>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.5: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;component&gt;_PACKAGE_NAME</span></code> variables.</p>
</div>
</dd></dl>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;component&gt;_PACKAGE_ARCHITECTURE</span></code> variables.</p>
</div>
</dd></dl>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.5: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;component&gt;_PACKAGE_GROUP</span></code> variables.</p>
</div>
</dd></dl>
...
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default : <span class="target" id="index-0-variable:CPACK_COMPONENT_&lt;compName&gt;_DESCRIPTION"></span><a class="reference internal" href="../module/CPackComponent.html#variable:CPACK_COMPONENT_&lt;compName&gt;_DESCRIPTION" title="CPACK_COMPONENT_&lt;compName&gt;_DESCRIPTION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_COMPONENT_&lt;compName&gt;_DESCRIPTION</span></code></a> (component
based installers only) if set, <span class="target" id="index-0-variable:CPACK_PACKAGE_DESCRIPTION_FILE"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_DESCRIPTION_FILE" title="CPACK_PACKAGE_DESCRIPTION_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_DESCRIPTION_FILE</span></code></a>
if set or &quot;no package description available&quot;</p></li>
</ul>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.2: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;component&gt;_PACKAGE_DESCRIPTION</span></code> variables.</p>
</div>
</dd></dl>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_REQUIRES &quot;python &gt;= 2.5.0, cmake &gt;= 2.8&quot;)
</pre></div>
</div>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_CONFLICTS &quot;libxml2&quot;)
</pre></div>
</div>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_REQUIRES_PRE &quot;shadow-utils, initscripts&quot;)
</pre></div>
</div>
</dd></dl>
...
you must enclose the complete requires string between quotes, for example:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_REQUIRES_POST &quot;shadow-utils, initscripts&quot;)
</pre></div>
</div>
</dd></dl>
...
example:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_REQUIRES_POSTUN &quot;shadow-utils, initscripts&quot;)
</pre></div>
</div>
</dd></dl>
...
you must enclose the complete requires string between quotes, for example:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_PACKAGE_REQUIRES_PREUN &quot;shadow-utils, initscripts&quot;)
</pre></div>
</div>
</dd></dl>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_SPEC_MORE_DEFINE &quot;%define __spec_install_post /bin/true&quot;)
</pre></div>
</div>
</dd></dl>
...
<dt id="variable:CPACK_RPM_PRE_TRANS_SCRIPT_FILE">
<code class="sig-name descname">CPACK_RPM_PRE_TRANS_SCRIPT_FILE</code><a class="headerlink" href="#variable:CPACK_RPM_PRE_TRANS_SCRIPT_FILE" title="Permalink to this definition">¶</a></dt>
...
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_PRE_INSTALL_SCRIPT_FILE</span></code>,
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_PRE_UNINSTALL_SCRIPT_FILE</span></code>, and
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_PRE_TRANS_SCRIPT_FILE</span></code>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.18: </span>The <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_PRE_TRANS_SCRIPT_FILE</span></code> variable.</p>
</div>
</dd></dl>
...
<dt id="variable:CPACK_RPM_POST_TRANS_SCRIPT_FILE">
<code class="sig-name descname">CPACK_RPM_POST_TRANS_SCRIPT_FILE</code><a class="headerlink" href="#variable:CPACK_RPM_POST_TRANS_SCRIPT_FILE" title="Permalink to this definition">¶</a></dt>
...
script for each component can be overridden with
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_POST_INSTALL_SCRIPT_FILE</span></code>,
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_POST_UNINSTALL_SCRIPT_FILE</span></code>, and
<code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_POST_TRANS_SCRIPT_FILE</span></code>
One may verify which scriptlet has been included with:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>rpm -qp --scripts  package.rpm
</pre></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.18: </span>The <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_POST_TRANS_SCRIPT_FILE</span></code> variable.</p>
</div>
</dd></dl>
...
user specified files of the <code class="docutils literal notranslate"><span class="pre">CPACK_RPM_&lt;COMPONENT&gt;_USER_FILELIST</span></code> list will
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>execute_process(COMMAND ${CMAKE_COMMAND}
...
example:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_RPM_BUILDREQUIRES &quot;python &gt;= 2.5.0, cmake &gt;= 2.8&quot;)
</pre></div>
</div>
</dd></dl>
