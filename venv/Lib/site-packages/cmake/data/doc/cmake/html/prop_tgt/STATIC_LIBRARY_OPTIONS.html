...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>STATIC_LIBRARY_OPTIONS &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="static-library-options">
<span id="prop_tgt:STATIC_LIBRARY_OPTIONS"></span><h1>STATIC_LIBRARY_OPTIONS<a class="headerlink" href="#static-library-options" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.13.</span></p>
</div>
<p>Archiver (or MSVC librarian) flags for a static library target.
Targets that are shared libraries, modules, or executables need to use
the <span class="target" id="index-0-prop_tgt:LINK_OPTIONS"></span><a class="reference internal" href="LINK_OPTIONS.html#prop_tgt:LINK_OPTIONS" title="LINK_OPTIONS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">LINK_OPTIONS</span></code></a> target property.</p>
<p>This property holds a <a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a> of options
specified so far for its target.  Use <span class="target" id="index-0-command:set_target_properties"></span><a class="reference internal" href="../command/set_target_properties.html#command:set_target_properties" title="set_target_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_target_properties()</span></code></a> or
<span class="target" id="index-0-command:set_property"></span><a class="reference internal" href="../command/set_property.html#command:set_property" title="set_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_property()</span></code></a> commands to set its content.</p>
<p>Contents of <code class="docutils literal notranslate"><span class="pre">STATIC_LIBRARY_OPTIONS</span></code> may use &quot;generator expressions&quot; with the
...
<p>This property must be used in preference to <span class="target" id="index-0-prop_tgt:STATIC_LIBRARY_FLAGS"></span><a class="reference internal" href="STATIC_LIBRARY_FLAGS.html#prop_tgt:STATIC_LIBRARY_FLAGS" title="STATIC_LIBRARY_FLAGS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">STATIC_LIBRARY_FLAGS</span></code></a>
property.</p>
</div>
...
<code class="docutils literal notranslate"><span class="pre">&quot;SHELL:-option</span> <span class="pre">A&quot;</span> <span class="pre">&quot;SHELL:-option</span> <span class="pre">B&quot;</span></code> becomes <code class="docutils literal notranslate"><span class="pre">-option</span> <span class="pre">A</span> <span class="pre">-option</span> <span class="pre">B</span></code>.</p>
  ...
  <ul>
<li><a class="reference internal" href="#">STATIC_LIBRARY_OPTIONS</a><ul>
<li><a class="reference internal" href="#option-de-duplication">Option De-duplication</a></li>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/prop_tgt/STATIC_LIBRARY_OPTIONS.rst.txt"
