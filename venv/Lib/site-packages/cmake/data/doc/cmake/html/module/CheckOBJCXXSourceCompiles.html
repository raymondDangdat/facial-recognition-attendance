...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckOBJCXXSourceCompiles &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CheckOBJCXXSourceRuns" href="CheckOBJCXXSourceRuns.html" />
    <link rel="prev" title="CheckOBJCXXCompilerFlag" href="CheckOBJCXXCompilerFlag.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CheckOBJCXXCompilerFlag.html" title="CheckOBJCXXCompilerFlag"
  ...
  <div class="section" id="checkobjcxxsourcecompiles">
<span id="module:CheckOBJCXXSourceCompiles"></span><h1>CheckOBJCXXSourceCompiles<a class="headerlink" href="#checkobjcxxsourcecompiles" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16.</span></p>
</div>
<p>Check if given Objective-C++ source compiles and links into an executable.</p>
<dl class="command">
<dt id="command:check_objcxx_source_compiles">
<code class="sig-name descname">check_objcxx_source_compiles</code><a class="headerlink" href="#command:check_objcxx_source_compiles" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_objcxx_source_compiles(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
<span class="w">                             </span><span class="p">[</span><span class="no">FAIL_REGEX</span><span class="w"> </span><span class="nv">&lt;regex1&gt;</span><span class="w"> </span><span class="p">[</span><span class="nv">&lt;regex2&gt;...</span><span class="p">]]</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
<p>Check that the source supplied in <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> can be compiled as a Objective-C++ source
file and linked as an executable (so it must contain at least a <code class="docutils literal notranslate"><span class="pre">main()</span></code>
function). The result will be stored in the internal cache variable specified
by <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code>, with a boolean true value for success and boolean false
for failure. If <code class="docutils literal notranslate"><span class="pre">FAIL_REGEX</span></code> is provided, then failure is determined by
checking if anything in the output matches any of the specified regular
expressions.</p>
<p>The underlying check is performed by the <span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="../command/try_compile.html#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command. The
compile and link commands can be influenced by setting any of the following
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_objcxx_source_compiles()</span></code>:</p>
<dl class="simple">
...
<code class="docutils literal notranslate"><span class="pre">try_compile()</span></code>, i.e. the contents of the <span class="target" id="index-0-prop_dir:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_dir/INCLUDE_DIRECTORIES.html#prop_dir:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a>
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckOBJCXXCompilerFlag.html"
                        title="previous chapter">CheckOBJCXXCompilerFlag</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="CheckOBJCXXSourceRuns.html"
                        title="next chapter">CheckOBJCXXSourceRuns</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CheckOBJCXXSourceCompiles.rst.txt"
