...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckSymbolExists &mdash; CMake 3.21.0 Documentation</title>
...
<p>Provides a macro to check if a symbol exists as a function, variable,
or macro in <code class="docutils literal notranslate"><span class="pre">C</span></code>.</p>
<dl class="command">
<dt id="command:check_symbol_exists">
<code class="sig-name descname">check_symbol_exists</code><a class="headerlink" href="#command:check_symbol_exists" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_symbol_exists(</span><span class="nv">&lt;symbol&gt;</span><span class="w"> </span><span class="nv">&lt;files&gt;</span><span class="w"> </span><span class="nv">&lt;variable&gt;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
<code class="docutils literal notranslate"><span class="pre">&lt;files&gt;</span></code> and store the result in a <code class="docutils literal notranslate"><span class="pre">&lt;variable&gt;</span></code>.  Specify the list
of files in one argument as a semicolon-separated list.
<code class="docutils literal notranslate"><span class="pre">&lt;variable&gt;</span></code> will be created as an internal cache variable.</p>
</dd></dl>
...
(consider using <span class="target" id="index-0-module:CheckTypeSize"></span><a class="reference internal" href="CheckTypeSize.html#module:CheckTypeSize" title="CheckTypeSize"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckTypeSize</span></code></a> or <span class="target" id="index-0-module:CheckCSourceCompiles"></span><a class="reference internal" href="CheckCSourceCompiles.html#module:CheckCSourceCompiles" title="CheckCSourceCompiles"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckCSourceCompiles</span></code></a>).
If the check needs to be done in C++, consider using
<span class="target" id="index-0-module:CheckCXXSymbolExists"></span><a class="reference internal" href="CheckCXXSymbolExists.html#module:CheckCXXSymbolExists" title="CheckCXXSymbolExists"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckCXXSymbolExists</span></code></a> instead.</p>
...
<span class="nf">check_symbol_exists(</span><span class="no">SEEK_SET</span><span class="w"> </span><span class="s">&quot;stdio.h&quot;</span><span class="w"> </span><span class="no">HAVE_SEEK_SET</span><span class="nf">)</span><span class="w"></span>
<span class="c"># Check for function fopen</span>
<span class="nf">check_symbol_exists(</span><span class="nb">fopen</span><span class="w"> </span><span class="s">&quot;stdio.h&quot;</span><span class="w"> </span><span class="no">HAVE_FOPEN</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
</div>
