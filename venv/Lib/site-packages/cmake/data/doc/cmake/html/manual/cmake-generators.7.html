...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>cmake-generators(7) &mdash; CMake 3.21.0 Documentation</title>
...
<h1><a class="toc-backref" href="#id6">cmake-generators(7)</a><a class="headerlink" href="#cmake-generators-7" title="Permalink to this headline">¶</a></h1>
...
<li><p><a class="reference internal" href="#cmake-generators" id="id8">CMake Generators</a></p>
<ul>
<li><p><a class="reference internal" href="#command-line-build-tool-generators" id="id9">Command-Line Build Tool Generators</a></p>
<ul>
<li><p><a class="reference internal" href="#makefile-generators" id="id10">Makefile Generators</a></p></li>
<li><p><a class="reference internal" href="#ninja-generators" id="id11">Ninja Generators</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#ide-build-tool-generators" id="id12">IDE Build Tool Generators</a></p>
<ul>
<li><p><a class="reference internal" href="#visual-studio-generators" id="id13">Visual Studio Generators</a></p></li>
<li><p><a class="reference internal" href="#other-generators" id="id14">Other Generators</a></p></li>
</ul>
</li>
</ul>
</li>
<li><p><a class="reference internal" href="#extra-generators" id="id15">Extra Generators</a></p></li>
</ul>
</li>
</ul>
</div>
...
on certain platforms.  The <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> command-line tool <code class="docutils literal notranslate"><span class="pre">--help</span></code>
output lists available generators on the current platform.  Use its <code class="docutils literal notranslate"><span class="pre">-G</span></code>
option to specify the generator for a new build tree.
The <span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> offers interactive selection of a generator
when creating a new build tree.</p>
</div>
<div class="section" id="cmake-generators">
<h2><a class="toc-backref" href="#id8">CMake Generators</a><a class="headerlink" href="#cmake-generators" title="Permalink to this headline">¶</a></h2>
<div class="section" id="command-line-build-tool-generators">
<span id="id1"></span><h3><a class="toc-backref" href="#id9">Command-Line Build Tool Generators</a><a class="headerlink" href="#command-line-build-tool-generators" title="Permalink to this headline">¶</a></h3>
...
<span id="id2"></span><h4><a class="toc-backref" href="#id10">Makefile Generators</a><a class="headerlink" href="#makefile-generators" title="Permalink to this headline">¶</a></h4>
...
<div class="section" id="ninja-generators">
<span id="id3"></span><h4><a class="toc-backref" href="#id11">Ninja Generators</a><a class="headerlink" href="#ninja-generators" title="Permalink to this headline">¶</a></h4>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="../generator/Ninja.html">Ninja</a></li>
<li class="toctree-l1"><a class="reference internal" href="../generator/Ninja Multi-Config.html">Ninja Multi-Config</a></li>
</ul>
</div>
</div>
</div>
<div class="section" id="ide-build-tool-generators">
<span id="id4"></span><h3><a class="toc-backref" href="#id12">IDE Build Tool Generators</a><a class="headerlink" href="#ide-build-tool-generators" title="Permalink to this headline">¶</a></h3>
...
<span id="id5"></span><h4><a class="toc-backref" href="#id13">Visual Studio Generators</a><a class="headerlink" href="#visual-studio-generators" title="Permalink to this headline">¶</a></h4>
<div class="toctree-wrapper compound">
<ul>
...
<li class="toctree-l1"><a class="reference internal" href="../generator/Visual Studio 16 2019.html">Visual Studio 16 2019</a></li>
<li class="toctree-l1"><a class="reference internal" href="../generator/Visual Studio 17 2022.html">Visual Studio 17 2022</a></li>
</ul>
</div>
</div>
<div class="section" id="other-generators">
<h4><a class="toc-backref" href="#id14">Other Generators</a><a class="headerlink" href="#other-generators" title="Permalink to this headline">¶</a></h4>
<div class="toctree-wrapper compound">
<ul>
...
<h2><a class="toc-backref" href="#id15">Extra Generators</a><a class="headerlink" href="#extra-generators" title="Permalink to this headline">¶</a></h2>
...
command-line tool <code class="docutils literal notranslate"><span class="pre">--help</span></code> output may have variants that specify
an extra generator for an auxiliary IDE tool.  Such generator
names have the form <code class="docutils literal notranslate"><span class="pre">&lt;extra-generator&gt;</span> <span class="pre">-</span> <span class="pre">&lt;main-generator&gt;</span></code>.
