...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_NO_BUILTIN_CHRPATH &mdash; CMake 3.21.0 Documentation</title>
...
<p>Do not use the builtin binary editor to fix runtime library search
paths on installation.</p>
<p>When an ELF or XCOFF binary needs to have a different runtime library
...
installation instead of using its builtin editor.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.20: </span>This variable also applies to XCOFF binaries' LIBPATH.  Prior to the
addition of the XCOFF editor in CMake 3.20, this variable applied only
to ELF binaries' RPATH/RUNPATH.</p>
</div>
</div>
