...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_INSTALL_DEFAULT_COMPONENT_NAME &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS" href="CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html" />
...
<p>Default component used in <span class="target" id="index-0-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install()</span></code></a> commands.</p>
<p>If an <span class="target" id="index-1-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install()</span></code></a> command is used without the <code class="docutils literal notranslate"><span class="pre">COMPONENT</span></code> argument,
...
defaults to <code class="docutils literal notranslate"><span class="pre">Unspecified</span></code>.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html"
                        title="next chapter">CMAKE_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS</a></p>
