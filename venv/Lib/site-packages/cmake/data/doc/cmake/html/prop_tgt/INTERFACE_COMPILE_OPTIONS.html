...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_COMPILE_OPTIONS &mdash; CMake 3.21.0 Documentation</title>
...
required to compile against the headers for the target.  The <span class="target" id="index-0-command:target_compile_options"></span><a class="reference internal" href="../command/target_compile_options.html#command:target_compile_options" title="target_compile_options"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_compile_options()</span></code></a>
...
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INTERFACE_COMPILE_OPTIONS</span></code> may use &quot;generator expressions&quot;
