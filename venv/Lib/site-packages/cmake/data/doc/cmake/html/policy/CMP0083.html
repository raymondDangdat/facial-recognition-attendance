...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0083 &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmp0083">
<span id="policy:CMP0083"></span><h1>CMP0083<a class="headerlink" href="#cmp0083" title="Permalink to this headline">¶</a></h1>
...
Unlike most policies, CMake version 3.21.0 does not warn when this policy is
not set and simply uses <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior.</p>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">cmake_minimum_required(</span><span class="no">VERSION</span><span class="w"> </span><span class="m">3.13</span><span class="nf">)</span><span class="w"></span>
<span class="nf">project(</span><span class="nb">foo</span><span class="nf">)</span><span class="w"></span>

<span class="c"># ...</span>

<span class="nf">add_executable(</span><span class="nb">foo</span><span class="w"> </span><span class="p">...</span><span class="nf">)</span><span class="w"></span>
...
<span class="nf">include(</span><span class="nb">CheckPIESupported</span><span class="nf">)</span><span class="w"></span>
<span class="nf">check_pie_supported()</span><span class="w"></span>
