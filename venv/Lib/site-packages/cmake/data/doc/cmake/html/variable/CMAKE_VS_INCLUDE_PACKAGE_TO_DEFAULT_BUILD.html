...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_VS_INCLUDE_PACKAGE_TO_DEFAULT_BUILD &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_VS_JUST_MY_CODE_DEBUGGING" href="CMAKE_VS_JUST_MY_CODE_DEBUGGING.html" />
...
<p>Include <code class="docutils literal notranslate"><span class="pre">PACKAGE</span></code> target to default build.</p>
<p>In Visual Studio solution, by default the <code class="docutils literal notranslate"><span class="pre">PACKAGE</span></code> target will not be part
of the default build. Setting this variable will enable the <code class="docutils literal notranslate"><span class="pre">PACKAGE</span></code> target
to be part of the default build.</p>
  ...
  <p class="topless"><a href="CMAKE_VS_JUST_MY_CODE_DEBUGGING.html"
                        title="next chapter">CMAKE_VS_JUST_MY_CODE_DEBUGGING</a></p>
