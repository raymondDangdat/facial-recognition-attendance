...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>add_test &mdash; CMake 3.21.0 Documentation</title>
...
<p>The <code class="docutils literal notranslate"><span class="pre">COMMAND</span></code> and <code class="docutils literal notranslate"><span class="pre">WORKING_DIRECTORY</span></code> options may use &quot;generator
...
<p>Add a test called <code class="docutils literal notranslate"><span class="pre">&lt;name&gt;</span></code> with the given command-line.  Unlike
the above <code class="docutils literal notranslate"><span class="pre">NAME</span></code> signature no transformation is performed on the
