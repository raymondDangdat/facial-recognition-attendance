...
format flag to the compiler.  Use the source-specific <code class="docutils literal notranslate"><span class="pre">Fortran_FORMAT</span></code>
property to change the format of a specific source file.  If the
variable <span class="target" id="index-0-variable:CMAKE_Fortran_FORMAT"></span><a class="reference internal" href="../variable/CMAKE_Fortran_FORMAT.html#variable:CMAKE_Fortran_FORMAT" title="CMAKE_Fortran_FORMAT"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_Fortran_FORMAT</span></code></a> is set when a target is created its
