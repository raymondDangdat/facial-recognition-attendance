...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>SKIP_BUILD_RPATH &mdash; CMake 3.21.0 Documentation</title>
...
<p><code class="docutils literal notranslate"><span class="pre">SKIP_BUILD_RPATH</span></code> is a boolean specifying whether to skip automatic
generation of an rpath allowing the target to run from the build tree.
This property is initialized by the value of the variable
<span class="target" id="index-0-variable:CMAKE_SKIP_BUILD_RPATH"></span><a class="reference internal" href="../variable/CMAKE_SKIP_BUILD_RPATH.html#variable:CMAKE_SKIP_BUILD_RPATH" title="CMAKE_SKIP_BUILD_RPATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_SKIP_BUILD_RPATH</span></code></a> if it is set when a target is created.</p>
</div>
