...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>PRIVATE_HEADER &mdash; CMake 3.21.0 Documentation</title>
...
<p>Specify private header files in a <span class="target" id="index-0-prop_tgt:FRAMEWORK"></span><a class="reference internal" href="FRAMEWORK.html#prop_tgt:FRAMEWORK" title="FRAMEWORK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">FRAMEWORK</span></code></a> shared library target.</p>
...
platforms these headers may be installed using the <code class="docutils literal notranslate"><span class="pre">PRIVATE_HEADER</span></code>
