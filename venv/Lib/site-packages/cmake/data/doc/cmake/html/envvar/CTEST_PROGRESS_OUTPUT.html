...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_PROGRESS_OUTPUT &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="ctest-progress-output">
<span id="envvar:CTEST_PROGRESS_OUTPUT"></span><h1>CTEST_PROGRESS_OUTPUT<a class="headerlink" href="#ctest-progress-output" title="Permalink to this headline">¶</a></h1>
...
output.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">--progress</span></code> option to <span class="target" id="index-1-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest</span></code></a> overrides this
environment variable if both are given.</p>
</div>
