...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_CUSTOM_MAXIMUM_PASSED_TEST_OUTPUT_SIZE &mdash; CMake 3.21.0 Documentation</title>
...
will be collected by the <span class="target" id="index-0-command:ctest_test"></span><a class="reference internal" href="../command/ctest_test.html#command:ctest_test" title="ctest_test"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_test()</span></code></a> command. Defaults to 1024
(1 KiB).</p>
