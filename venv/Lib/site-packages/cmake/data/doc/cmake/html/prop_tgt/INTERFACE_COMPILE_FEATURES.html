...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_COMPILE_FEATURES &mdash; CMake 3.21.0 Documentation</title>
...
required to compile against the headers for the target.  The <span class="target" id="index-0-command:target_compile_features"></span><a class="reference internal" href="../command/target_compile_features.html#command:target_compile_features" title="target_compile_features"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_compile_features()</span></code></a>
...
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INTERFACE_COMPILE_FEATURES</span></code> may use &quot;generator expressions&quot;
