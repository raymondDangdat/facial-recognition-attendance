...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VERSION &mdash; CMake 3.21.0 Documentation</title>
...
<p>For shared libraries <code class="docutils literal notranslate"><span class="pre">VERSION</span></code> and <span class="target" id="index-0-prop_tgt:SOVERSION"></span><a class="reference internal" href="SOVERSION.html#prop_tgt:SOVERSION" title="SOVERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOVERSION</span></code></a> can be used
to specify the build version and API version respectively.  When building or
installing appropriate symlinks are created if the platform supports
symlinks and the linker supports so-names.  If only one of both is
specified the missing is assumed to have the same version number.  For
executables <code class="docutils literal notranslate"><span class="pre">VERSION</span></code> can be used to specify the build version.  When
...
<p>For shared libraries and executables on Windows the <code class="docutils literal notranslate"><span class="pre">VERSION</span></code>
...
the <span class="target" id="index-1-prop_tgt:SOVERSION"></span><a class="reference internal" href="SOVERSION.html#prop_tgt:SOVERSION" title="SOVERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOVERSION</span></code></a> property corresponds to the <em>compatibility version</em>
and <code class="docutils literal notranslate"><span class="pre">VERSION</span></code> corresponds to the <em>current version</em> (unless Mach-O specific
...
Note that <span class="target" id="index-2-prop_tgt:SOVERSION"></span><a class="reference internal" href="SOVERSION.html#prop_tgt:SOVERSION" title="SOVERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOVERSION</span></code></a> will still be used to form the
<code class="docutils literal notranslate"><span class="pre">install_name</span></code> and both <span class="target" id="index-3-prop_tgt:SOVERSION"></span><a class="reference internal" href="SOVERSION.html#prop_tgt:SOVERSION" title="SOVERSION"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOVERSION</span></code></a> and <code class="docutils literal notranslate"><span class="pre">VERSION</span></code> may also
affect the file and symlink names.</p>
