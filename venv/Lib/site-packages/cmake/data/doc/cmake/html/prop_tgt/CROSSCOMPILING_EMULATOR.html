...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CROSSCOMPILING_EMULATOR &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CUDA_ARCHITECTURES" href="CUDA_ARCHITECTURES.html" />
...
This command will be added as a prefix to <span class="target" id="index-0-command:add_test"></span><a class="reference internal" href="../command/add_test.html#command:add_test" title="add_test"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_test()</span></code></a>,
...
<p>If this property contains a <a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a>, then the first value is the command and remaining values are its
arguments.</p>
<p>This property is initialized by the value of the
<span class="target" id="index-0-variable:CMAKE_CROSSCOMPILING_EMULATOR"></span><a class="reference internal" href="../variable/CMAKE_CROSSCOMPILING_EMULATOR.html#variable:CMAKE_CROSSCOMPILING_EMULATOR" title="CMAKE_CROSSCOMPILING_EMULATOR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CROSSCOMPILING_EMULATOR</span></code></a> variable if it is set when a target
is created.</p>
</div>
  ...
  <p class="topless"><a href="CUDA_ARCHITECTURES.html"
                        title="next chapter">CUDA_ARCHITECTURES</a></p>
