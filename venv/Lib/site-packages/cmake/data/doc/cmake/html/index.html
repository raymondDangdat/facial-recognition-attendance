...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMake Reference Documentation &mdash; CMake 3.21.0 Documentation</title>
...
<p>CMake is a tool to manage building of source code.  Originally, CMake was
designed as a generator for various dialects of <code class="docutils literal notranslate"><span class="pre">Makefile</span></code>, today
CMake generates modern buildsystems such as <code class="docutils literal notranslate"><span class="pre">Ninja</span></code> as well as project
files for IDEs such as Visual Studio and Xcode.</p>
<p>CMake is widely used for the C and C++ languages, but it may be used to
build source code of other languages too.</p>
<p>People encountering CMake for the first time may have different initial
goals.  To learn how to build a source code package downloaded from the
internet, start with the <span class="target" id="index-0-guide:User Interaction Guide"></span><a class="reference internal" href="guide/user-interaction/index.html#guide:User Interaction Guide" title="User Interaction Guide"><code class="xref cmake cmake-guide docutils literal notranslate"><span class="pre">User</span> <span class="pre">Interaction</span> <span class="pre">Guide</span></code></a>.
This will detail the steps needed to run the <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> or
<span class="target" id="index-0-manual:cmake-gui(1)"></span><a class="reference internal" href="manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> executable and how to choose a generator, and
how to complete the build.</p>
<p>The <span class="target" id="index-0-guide:Using Dependencies Guide"></span><a class="reference internal" href="guide/using-dependencies/index.html#guide:Using Dependencies Guide" title="Using Dependencies Guide"><code class="xref cmake cmake-guide docutils literal notranslate"><span class="pre">Using</span> <span class="pre">Dependencies</span> <span class="pre">Guide</span></code></a> is aimed at developers
wishing to get started using a third-party library.</p>
<p>For developers starting a project using CMake, the <span class="target" id="index-0-guide:CMake Tutorial"></span><a class="reference internal" href="guide/tutorial/index.html#guide:CMake Tutorial" title="CMake Tutorial"><code class="xref cmake cmake-guide docutils literal notranslate"><span class="pre">CMake</span> <span class="pre">Tutorial</span></code></a>
is a suitable starting point.  The <span class="target" id="index-0-manual:cmake-buildsystem(7)"></span><a class="reference internal" href="manual/cmake-buildsystem.7.html#manual:cmake-buildsystem(7)" title="cmake-buildsystem(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-buildsystem(7)</span></code></a>
...
<li class="toctree-l1"><a class="reference internal" href="manual/cmake-env-variables.7.html">cmake-env-variables(7)</a></li>
<li class="toctree-l1"><a class="reference internal" href="manual/cmake-file-api.7.html">cmake-file-api(7)</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="manual/cmake-presets.7.html">cmake-presets(7)</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="manual/cpack-generators.7.html">cpack-generators(7)</a></li>
</ul>
</div>
</div>
...
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="guide/tutorial/index.html">CMake Tutorial</a></li>
<li class="toctree-l1"><a class="reference internal" href="guide/user-interaction/index.html">User Interaction Guide</a></li>
<li class="toctree-l1"><a class="reference internal" href="guide/using-dependencies/index.html">Using Dependencies Guide</a></li>
<li class="toctree-l1"><a class="reference internal" href="guide/importing-exporting/index.html">Importing and Exporting Guide</a></li>
<li class="toctree-l1"><a class="reference internal" href="guide/ide-integration/index.html">IDE Integration Guide</a></li>
</ul>
</div>
</div>
