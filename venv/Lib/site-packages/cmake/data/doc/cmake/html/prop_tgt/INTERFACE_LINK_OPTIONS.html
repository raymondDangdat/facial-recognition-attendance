...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_LINK_OPTIONS &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="interface-link-options">
<span id="prop_tgt:INTERFACE_LINK_OPTIONS"></span><h1>INTERFACE_LINK_OPTIONS<a class="headerlink" href="#interface-link-options" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.13.</span></p>
</div>
<p>List of public link options requirements for a library.</p>
<p>Targets may populate this property to publish the link options
required to compile against the headers for the target.  The <span class="target" id="index-0-command:target_link_options"></span><a class="reference internal" href="../command/target_link_options.html#command:target_link_options" title="target_link_options"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_link_options()</span></code></a>
...
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INTERFACE_LINK_OPTIONS</span></code> may use &quot;generator expressions&quot;
...
-manual for more on defining buildsystem properties.</p>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/prop_tgt/INTERFACE_LINK_OPTIONS.rst.txt"
