...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_VERBOSE_MAKEFILE &mdash; CMake 3.21.0 Documentation</title>
...
<p>This variable is a cache entry initialized (to <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>) by
the <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> command.  Users may enable the option
