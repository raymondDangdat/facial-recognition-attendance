...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindIconv &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="variable">
<dt id="variable:Iconv_FOUND">
<code class="sig-name descname">Iconv_FOUND</code><a class="headerlink" href="#variable:Iconv_FOUND" title="Permalink to this definition">¶</a></dt>
<dd><p>Variable indicating if the iconv support was found.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_INCLUDE_DIRS">
<code class="sig-name descname">Iconv_INCLUDE_DIRS</code><a class="headerlink" href="#variable:Iconv_INCLUDE_DIRS" title="Permalink to this definition">¶</a></dt>
<dd><p>The directories containing the iconv headers.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_LIBRARIES">
<code class="sig-name descname">Iconv_LIBRARIES</code><a class="headerlink" href="#variable:Iconv_LIBRARIES" title="Permalink to this definition">¶</a></dt>
<dd><p>The iconv libraries to be linked.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_VERSION">
<code class="sig-name descname">Iconv_VERSION</code><a class="headerlink" href="#variable:Iconv_VERSION" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:Iconv_VERSION_MAJOR">
<code class="sig-name descname">Iconv_VERSION_MAJOR</code><a class="headerlink" href="#variable:Iconv_VERSION_MAJOR" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.21.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:Iconv_VERSION_MINOR">
<code class="sig-name descname">Iconv_VERSION_MINOR</code><a class="headerlink" href="#variable:Iconv_VERSION_MINOR" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.21.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:Iconv_IS_BUILT_IN">
<code class="sig-name descname">Iconv_IS_BUILT_IN</code><a class="headerlink" href="#variable:Iconv_IS_BUILT_IN" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:Iconv::Iconv">
<code class="sig-name descname">Iconv::Iconv</code><a class="headerlink" href="#variable:Iconv::Iconv" title="Permalink to this definition">¶</a></dt>
<dd><p>Imported target for using iconv.</p>
</dd></dl>

<p>The following cache variables may also be set:</p>
<dl class="variable">
<dt id="variable:Iconv_INCLUDE_DIR">
<code class="sig-name descname">Iconv_INCLUDE_DIR</code><a class="headerlink" href="#variable:Iconv_INCLUDE_DIR" title="Permalink to this definition">¶</a></dt>
<dd><p>The directory containing the iconv headers.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:Iconv_LIBRARY">
<code class="sig-name descname">Iconv_LIBRARY</code><a class="headerlink" href="#variable:Iconv_LIBRARY" title="Permalink to this definition">¶</a></dt>
