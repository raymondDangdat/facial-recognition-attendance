...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0045 &mdash; CMake 3.21.0 Documentation</title>
...
<p>In CMake 2.8.12 and lower, the <span class="target" id="index-0-command:get_target_property"></span><a class="reference internal" href="../command/get_target_property.html#command:get_target_property" title="get_target_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">get_target_property()</span></code></a> command accepted
a non-existent target argument without issuing any error or warning.  The
result variable is set to a <code class="docutils literal notranslate"><span class="pre">-NOTFOUND</span></code> value.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy is to issue no warning and set the result
variable to a <code class="docutils literal notranslate"><span class="pre">-NOTFOUND</span></code> value.  The <code class="docutils literal notranslate"><span class="pre">NEW</span></code> behavior
for this policy is to issue a <code class="docutils literal notranslate"><span class="pre">FATAL_ERROR</span></code> if the command is called with a
