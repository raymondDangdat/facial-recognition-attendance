...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>IMPORT_SUFFIX &mdash; CMake 3.21.0 Documentation</title>
...
<p>Similar to the target property <span class="target" id="index-0-prop_tgt:SUFFIX"></span><a class="reference internal" href="SUFFIX.html#prop_tgt:SUFFIX" title="SUFFIX"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SUFFIX</span></code></a>, but used
for import libraries (typically corresponding to a <code class="docutils literal notranslate"><span class="pre">DLL</span></code>) instead of
regular libraries.  A target property that can be set to override
the suffix (such as <code class="docutils literal notranslate"><span class="pre">.lib</span></code>) on an import library name.</p>
</div>
