...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPACK_INCLUDE_TOPLEVEL_DIRECTORY &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS" href="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html" title="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS"
...
top level directory.  The purpose of is to include (set to <code class="docutils literal notranslate"><span class="pre">1</span></code> or <code class="docutils literal notranslate"><span class="pre">ON</span></code> or
<code class="docutils literal notranslate"><span class="pre">TRUE</span></code>) the top level directory in the package or not (set to <code class="docutils literal notranslate"><span class="pre">0</span></code> or
<code class="docutils literal notranslate"><span class="pre">OFF</span></code> or <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>).</p>
...
backward compatibility) reason.</p>
  ...
  <h4>Next topic</h4>
  <p class="topless"><a href="CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS.html"
                        title="next chapter">CPACK_INSTALL_DEFAULT_DIRECTORY_PERMISSIONS</a></p>
