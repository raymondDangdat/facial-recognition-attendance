...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_INSTALL_NAME_DIR &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH" href="CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH.html" />
...
<p><code class="docutils literal notranslate"><span class="pre">CMAKE_INSTALL_NAME_DIR</span></code> is used to initialize the
<span class="target" id="index-0-prop_tgt:INSTALL_NAME_DIR"></span><a class="reference internal" href="../prop_tgt/INSTALL_NAME_DIR.html#prop_tgt:INSTALL_NAME_DIR" title="INSTALL_NAME_DIR"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INSTALL_NAME_DIR</span></code></a> property on all targets.  See that target
property for more information.</p>
  ...
  <p class="topless"><a href="CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH.html"
                        title="next chapter">CMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH</a></p>
