...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>AddFileDependencies &mdash; CMake 3.21.0 Documentation</title>
...
<p><span class="versionmodified deprecated">Deprecated since version 3.20.</span></p>
</div>
<p>Add dependencies to a source file.</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">add_file_dependencies(</span><span class="nv">&lt;source&gt;</span><span class="w"> </span><span class="nv">&lt;files&gt;...</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
<p>Adds the given <code class="docutils literal notranslate"><span class="pre">&lt;files&gt;</span></code> to the dependencies of file <code class="docutils literal notranslate"><span class="pre">&lt;source&gt;</span></code>.</p>
<p>Do not use this command in new code.  It is just a wrapper around:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set_property(</span><span class="no">SOURCE</span><span class="w"> </span><span class="nv">&lt;source&gt;</span><span class="w"> </span><span class="no">APPEND</span><span class="w"> </span><span class="no">PROPERTY</span><span class="w"> </span><span class="no">OBJECT_DEPENDS</span><span class="w"> </span><span class="nv">&lt;files&gt;...</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
