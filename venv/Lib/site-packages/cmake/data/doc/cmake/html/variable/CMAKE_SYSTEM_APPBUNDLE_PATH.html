...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_SYSTEM_APPBUNDLE_PATH &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_SYSROOT_LINK" href="CMAKE_SYSROOT_LINK.html" />
...
<p>Search path for macOS application bundles used by the <span class="target" id="index-0-command:find_program"></span><a class="reference internal" href="../command/find_program.html#command:find_program" title="find_program"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_program()</span></code></a>,
and <span class="target" id="index-0-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> commands.  By default it contains the standard
...
the project, use <span class="target" id="index-0-variable:CMAKE_APPBUNDLE_PATH"></span><a class="reference internal" href="CMAKE_APPBUNDLE_PATH.html#variable:CMAKE_APPBUNDLE_PATH" title="CMAKE_APPBUNDLE_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_APPBUNDLE_PATH</span></code></a> for this.</p>
  ...
  <p class="topless"><a href="CMAKE_SYSROOT_LINK.html"
                        title="previous chapter">CMAKE_SYSROOT_LINK</a></p>
  <h4>Next topic</h4>
