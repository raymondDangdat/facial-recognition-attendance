...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindBLAS &mdash; CMake 3.21.0 Documentation</title>
...
<a class="reference external" href="http://www.netlib.org/blas/">BLAS linear-algebra interface</a>.</p>
...
<div class="section" id="blas-lapack-vendors">
<span id="id1"></span><h2>BLAS/LAPACK Vendors<a class="headerlink" href="#blas-lapack-vendors" title="Permalink to this headline">¶</a></h2>
<dl>
...
<dt><code class="docutils literal notranslate"><span class="pre">Fujitsu_SSL2</span></code>, <code class="docutils literal notranslate"><span class="pre">Fujitsu_SSL2BLAMP</span></code></dt><dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.20.</span></p>
</div>
<p>Fujitsu SSL2 serial and parallel blas/lapack</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">Goto</span></code></dt><dd><p>GotoBLAS</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">IBMESSL</span></code></dt><dd><p>IBM Engineering and Scientific Subroutine Library</p>
</dd>
...
<dt><code class="docutils literal notranslate"><span class="pre">SCSL</span></code></dt><dd><p>Scientific Computing Software Library</p>
</dd>
...
<span id="id2"></span><h2>Intel MKL<a class="headerlink" href="#intel-mkl" title="Permalink to this headline">¶</a></h2>
