...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_NETRC &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_NETRC_FILE" href="CMAKE_NETRC_FILE.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_NETRC_FILE.html" title="CMAKE_NETRC_FILE"
  ...
  <div class="section" id="cmake-netrc">
<span id="variable:CMAKE_NETRC"></span><h1>CMAKE_NETRC<a class="headerlink" href="#cmake-netrc" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.11.</span></p>
</div>
<p>This variable is used to initialize the <code class="docutils literal notranslate"><span class="pre">NETRC</span></code> option for
...
<p>The local option takes precedence over this variable.</p>
  ...
  <h4>Next topic</h4>
  <p class="topless"><a href="CMAKE_NETRC_FILE.html"
                        title="next chapter">CMAKE_NETRC_FILE</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_NETRC.rst.txt"
