...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>find_package &mdash; CMake 3.21.0 Documentation</title>
...
<span id="command:find_package"></span><h1><a class="toc-backref" href="#id1">find_package</a><a class="headerlink" href="#find-package" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title">Contents</p>
<ul class="simple">
<li><p><a class="reference internal" href="#find-package" id="id1">find_package</a></p>
<ul>
<li><p><a class="reference internal" href="#basic-signature-and-module-mode" id="id2">Basic Signature and Module Mode</a></p></li>
<li><p><a class="reference internal" href="#full-signature-and-config-mode" id="id3">Full Signature and Config Mode</a></p></li>
<li><p><a class="reference internal" href="#version-selection" id="id4">Version Selection</a></p></li>
<li><p><a class="reference internal" href="#search-procedure" id="id5">Search Procedure</a></p></li>
<li><p><a class="reference internal" href="#package-file-interface-variables" id="id6">Package File Interface Variables</a></p></li>
</ul>
</li>
</ul>
</div>
<p>Find an external project, and load its settings.</p>
<div class="section" id="basic-signature-and-module-mode">
<span id="basic-signature"></span><h2><a class="toc-backref" href="#id2">Basic Signature and Module Mode</a><a class="headerlink" href="#basic-signature-and-module-mode" title="Permalink to this headline">¶</a></h2>
...
<p>Finds and loads settings from an external project.  <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FOUND</span></code>
...
<code class="docutils literal notranslate"><span class="pre">COMPONENTS</span></code> option (or after the <code class="docutils literal notranslate"><span class="pre">REQUIRED</span></code> option if present).
Additional optional components may be listed after
<code class="docutils literal notranslate"><span class="pre">OPTIONAL_COMPONENTS</span></code>.  Available components and their influence on
...
<blockquote>
<div><ul class="simple">
<li><p>A single version with the format <code class="docutils literal notranslate"><span class="pre">major[.minor[.patch[.tweak]]]</span></code>.</p></li>
...
<code class="docutils literal notranslate"><span class="pre">versionMin</span></code> and <code class="docutils literal notranslate"><span class="pre">versionMax</span></code> have the same format as the single
version.  By default, both end points are included.  By specifying <code class="docutils literal notranslate"><span class="pre">&lt;</span></code>,
the upper end point will be excluded.  Version ranges are only supported
with CMake 3.19 or later.</p></li>
</ul>
</div></blockquote>
...
below. This fall back is disabled if the <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> option is given.</p>
<p>In Module mode, CMake searches for a file called <code class="docutils literal notranslate"><span class="pre">Find&lt;PackageName&gt;.cmake</span></code>.
The file is first searched in the <span class="target" id="index-0-variable:CMAKE_MODULE_PATH"></span><a class="reference internal" href="../variable/CMAKE_MODULE_PATH.html#variable:CMAKE_MODULE_PATH" title="CMAKE_MODULE_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_MODULE_PATH</span></code></a>,
...
check the module documentation.</p>
<p>If the <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> option is not specified in the above signature,
...
may set the variable <span class="target" id="index-0-variable:CMAKE_FIND_PACKAGE_PREFER_CONFIG"></span><a class="reference internal" href="../variable/CMAKE_FIND_PACKAGE_PREFER_CONFIG.html#variable:CMAKE_FIND_PACKAGE_PREFER_CONFIG" title="CMAKE_FIND_PACKAGE_PREFER_CONFIG"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_PACKAGE_PREFER_CONFIG</span></code></a> to
<code class="docutils literal notranslate"><span class="pre">TRUE</span></code> to direct CMake first search using Config mode before falling
back to Module mode.</p>
</div>
<div class="section" id="full-signature-and-config-mode">
<h2><a class="toc-backref" href="#id3">Full Signature and Config Mode</a><a class="headerlink" href="#full-signature-and-config-mode" title="Permalink to this headline">¶</a></h2>
<p>User code should generally look for packages using the above <a class="reference internal" href="#basic-signature">basic
signature</a>.  The remainder of this command documentation specifies the
...
<code class="docutils literal notranslate"><span class="pre">&lt;lower-case-package-name&gt;-config.cmake</span></code> for each name specified.
A replacement set of possible configuration file names may be given
using the <code class="docutils literal notranslate"><span class="pre">CONFIGS</span></code> option.  The search procedure is specified below.
...
version are stored in the cmake variable <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_CONSIDERED_CONFIGS</span></code>,
the associated versions in <code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_CONSIDERED_VERSIONS</span></code>.</p>
...
encouraged to name and install them such that the <a class="reference internal" href="#search-procedure">Search Procedure</a>
outlined below will find them without requiring use of additional options.</p>
</div>
<div class="section" id="version-selection">
<h2><a class="toc-backref" href="#id4">Version Selection</a><a class="headerlink" href="#version-selection" title="Permalink to this headline">¶</a></h2>
...
<div class="section" id="search-procedure">
<h2><a class="toc-backref" href="#id5">Search Procedure</a><a class="headerlink" href="#search-procedure" title="Permalink to this headline">¶</a></h2>
...
<p><span class="versionmodified added">New in version 3.16: </span>Added the <code class="docutils literal notranslate"><span class="pre">CMAKE_FIND_USE_&lt;CATEGORY&gt;_PATH</span></code> variables to globally disable
...
<span class="target" id="index-0-variable:CMAKE_FIND_ROOT_PATH_MODE_PACKAGE"></span><a class="reference internal" href="../variable/CMAKE_FIND_ROOT_PATH_MODE_PACKAGE.html#variable:CMAKE_FIND_ROOT_PATH_MODE_PACKAGE" title="CMAKE_FIND_ROOT_PATH_MODE_PACKAGE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_FIND_ROOT_PATH_MODE_PACKAGE</span></code></a>.  This behavior can be manually
...
<p>Every non-REQUIRED <code class="docutils literal notranslate"><span class="pre">find_package</span></code> call can be disabled by setting the
<span class="target" id="index-0-variable:CMAKE_DISABLE_FIND_PACKAGE_&lt;PackageName&gt;"></span><a class="reference internal" href="../variable/CMAKE_DISABLE_FIND_PACKAGE_PackageName.html#variable:CMAKE_DISABLE_FIND_PACKAGE_&lt;PackageName&gt;" title="CMAKE_DISABLE_FIND_PACKAGE_&lt;PackageName&gt;"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_DISABLE_FIND_PACKAGE_&lt;PackageName&gt;</span></code></a> variable to <code class="docutils literal notranslate"><span class="pre">TRUE</span></code>.</p>
</div>
<div class="section" id="package-file-interface-variables">
<h2><a class="toc-backref" href="#id6">Package File Interface Variables</a><a class="headerlink" href="#package-file-interface-variables" title="Permalink to this headline">¶</a></h2>
...
<dt><code class="docutils literal notranslate"><span class="pre">&lt;PackageName&gt;_FIND_COMPONENTS</span></code></dt><dd><p>List of requested components</p>
</dd>
...
<li><a class="reference internal" href="#basic-signature-and-module-mode">Basic Signature and Module Mode</a></li>
<li><a class="reference internal" href="#full-signature-and-config-mode">Full Signature and Config Mode</a></li>
<li><a class="reference internal" href="#version-selection">Version Selection</a></li>
<li><a class="reference internal" href="#search-procedure">Search Procedure</a></li>
