...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>SUFFIX &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="STATIC_LIBRARY_OPTIONS" href="STATIC_LIBRARY_OPTIONS.html" />
...
<code class="docutils literal notranslate"><span class="pre">.so</span></code> or <code class="docutils literal notranslate"><span class="pre">.exe</span></code>) on the name of a library, module or executable.</p>
</div>
  ...
  <p class="topless"><a href="STATIC_LIBRARY_OPTIONS.html"
                        title="previous chapter">STATIC_LIBRARY_OPTIONS</a></p>
  <h4>Next topic</h4>
