...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_CURRENT_FUNCTION &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_CURRENT_FUNCTION_LIST_DIR" href="CMAKE_CURRENT_FUNCTION_LIST_DIR.html" />
  ...
  <div class="section" id="cmake-current-function">
<span id="variable:CMAKE_CURRENT_FUNCTION"></span><h1>CMAKE_CURRENT_FUNCTION<a class="headerlink" href="#cmake-current-function" title="Permalink to this headline">¶</a></h1>
...
diagnostic or debug messages.</p>
<p>See also <span class="target" id="index-0-variable:CMAKE_CURRENT_FUNCTION_LIST_DIR"></span><a class="reference internal" href="CMAKE_CURRENT_FUNCTION_LIST_DIR.html#variable:CMAKE_CURRENT_FUNCTION_LIST_DIR" title="CMAKE_CURRENT_FUNCTION_LIST_DIR"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CURRENT_FUNCTION_LIST_DIR</span></code></a>,
...
<span class="target" id="index-0-variable:CMAKE_CURRENT_FUNCTION_LIST_LINE"></span><a class="reference internal" href="CMAKE_CURRENT_FUNCTION_LIST_LINE.html#variable:CMAKE_CURRENT_FUNCTION_LIST_LINE" title="CMAKE_CURRENT_FUNCTION_LIST_LINE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CURRENT_FUNCTION_LIST_LINE</span></code></a>.</p>
  ...
  <p class="topless"><a href="CMAKE_CURRENT_FUNCTION_LIST_DIR.html"
                        title="next chapter">CMAKE_CURRENT_FUNCTION_LIST_DIR</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_CURRENT_FUNCTION.rst.txt"
