...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMakeFindDependencyMacro &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="command">
<dt id="command:find_dependency">
<code class="sig-name descname">find_dependency</code><a class="headerlink" href="#command:find_dependency" title="Permalink to this definition">¶</a></dt>
