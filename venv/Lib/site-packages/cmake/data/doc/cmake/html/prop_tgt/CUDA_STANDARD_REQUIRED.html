...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CUDA_STANDARD_REQUIRED &mdash; CMake 3.21.0 Documentation</title>
...
<p>Boolean describing whether the value of <span class="target" id="index-0-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_STANDARD</span></code></a> is a requirement.</p>
<p>If this property is set to <code class="docutils literal notranslate"><span class="pre">ON</span></code>, then the value of the
<span class="target" id="index-1-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_STANDARD</span></code></a> target property is treated as a requirement.  If this
property is <code class="docutils literal notranslate"><span class="pre">OFF</span></code> or unset, the <span class="target" id="index-2-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_STANDARD</span></code></a> target property is
treated as optional and may &quot;decay&quot; to a previous standard if the requested is
not available.  For compilers that have no notion of a standard level, such as
MSVC 1800 (Visual Studio 2013) and lower, this has no effect.</p>
