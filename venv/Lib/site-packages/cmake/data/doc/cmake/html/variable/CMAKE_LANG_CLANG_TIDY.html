...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_&lt;LANG&gt;_CLANG_TIDY &mdash; CMake 3.21.0 Documentation</title>
...
when <code class="docutils literal notranslate"><span class="pre">&lt;LANG&gt;</span></code> is <code class="docutils literal notranslate"><span class="pre">C</span></code>, <code class="docutils literal notranslate"><span class="pre">CXX</span></code>, <code class="docutils literal notranslate"><span class="pre">OBJC</span></code> or <code class="docutils literal notranslate"><span class="pre">OBJCXX</span></code>.</p>
<p>This variable is used to initialize the property on each target as it is
created.  For example:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set(</span><span class="no">CMAKE_CXX_CLANG_TIDY</span><span class="w"> </span><span class="nb">clang-tidy</span><span class="w"> </span><span class="p">-</span><span class="nb">checks</span><span class="p">=-*,</span><span class="nb">readability-</span><span class="p">*</span><span class="nf">)</span><span class="w"></span>
<span class="nf">add_executable(</span><span class="nb">foo</span><span class="w"> </span><span class="nb">foo.cxx</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
</div>
