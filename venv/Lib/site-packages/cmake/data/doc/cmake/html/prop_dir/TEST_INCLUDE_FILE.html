...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>TEST_INCLUDE_FILE &mdash; CMake 3.21.0 Documentation</title>
...
<p>Deprecated.  Use <span class="target" id="index-0-prop_dir:TEST_INCLUDE_FILES"></span><a class="reference internal" href="TEST_INCLUDE_FILES.html#prop_dir:TEST_INCLUDE_FILES" title="TEST_INCLUDE_FILES"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">TEST_INCLUDE_FILES</span></code></a> instead.</p>
<p>A cmake file that will be included when ctest is run.</p>
<p>If you specify <code class="docutils literal notranslate"><span class="pre">TEST_INCLUDE_FILE</span></code>, that file will be included and
