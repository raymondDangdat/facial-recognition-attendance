...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckSourceCompiles &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="checksourcecompiles">
<span id="module:CheckSourceCompiles"></span><h1>CheckSourceCompiles<a class="headerlink" href="#checksourcecompiles" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.19.</span></p>
</div>
<p>Check if given source compiles and links into an executable.</p>
<dl class="command">
<dt id="command:check_source_compiles">
<code class="sig-name descname">check_source_compiles</code><a class="headerlink" href="#command:check_source_compiles" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_source_compiles(</span><span class="nv">&lt;lang&gt;</span><span class="w"> </span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
<span class="w">                      </span><span class="p">[</span><span class="no">FAIL_REGEX</span><span class="w"> </span><span class="nv">&lt;regex1&gt;</span><span class="w"> </span><span class="p">[</span><span class="nv">&lt;regex2&gt;...</span><span class="p">]]</span><span class="w"></span>
...
<p>Check that the source supplied in <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> can be compiled as a source
file for the requested language and linked as an executable (so it must
contain at least a <code class="docutils literal notranslate"><span class="pre">main()</span></code> function). The result will be stored in the
internal cache variable specified by <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code>, with a boolean true
value for success and boolean false for failure. If <code class="docutils literal notranslate"><span class="pre">FAIL_REGEX</span></code> is
provided, then failure is determined by checking if anything in the output
matches any of the specified regular expressions.</p>
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_source_compiles()</span></code>:</p>
<dl class="simple">
