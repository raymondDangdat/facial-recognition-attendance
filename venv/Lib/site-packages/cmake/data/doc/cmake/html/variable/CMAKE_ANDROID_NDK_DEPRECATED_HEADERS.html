...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_ANDROID_NDK_DEPRECATED_HEADERS &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmake-android-ndk-deprecated-headers">
<span id="variable:CMAKE_ANDROID_NDK_DEPRECATED_HEADERS"></span><h1>CMAKE_ANDROID_NDK_DEPRECATED_HEADERS<a class="headerlink" href="#cmake-android-ndk-deprecated-headers" title="Permalink to this headline">¶</a></h1>
...
headers instead of the unified headers.</p>
<p>If not specified, the default will be <em>false</em> if using a NDK version
that provides the unified headers and <em>true</em> otherwise.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_ANDROID_NDK_DEPRECATED_HEADERS.rst.txt"
