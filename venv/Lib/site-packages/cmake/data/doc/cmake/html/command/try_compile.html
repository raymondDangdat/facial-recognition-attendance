...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>try_compile &mdash; CMake 3.21.0 Documentation</title>
...
<ul class="simple">
<li><p><a class="reference internal" href="#try-compile" id="id1">try_compile</a></p>
<ul>
<li><p><a class="reference internal" href="#try-compiling-whole-projects" id="id2">Try Compiling Whole Projects</a></p></li>
<li><p><a class="reference internal" href="#try-compiling-source-files" id="id3">Try Compiling Source Files</a></p></li>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">try_compile(</span><span class="nv">&lt;resultVar&gt;</span><span class="w"> </span><span class="nv">&lt;bindir&gt;</span><span class="w"> </span><span class="nv">&lt;srcdir&gt;</span><span class="w"></span>
<span class="w">            </span><span class="nv">&lt;projectName&gt;</span><span class="w"> </span><span class="p">[</span><span class="nv">&lt;targetName&gt;</span><span class="p">]</span><span class="w"> </span><span class="p">[</span><span class="no">CMAKE_FLAGS</span><span class="w"> </span><span class="nv">&lt;flags&gt;...</span><span class="p">]</span><span class="w"></span>
...
<p>Try building a project.  The success or failure of the <code class="docutils literal notranslate"><span class="pre">try_compile</span></code>,
i.e. <code class="docutils literal notranslate"><span class="pre">TRUE</span></code> or <code class="docutils literal notranslate"><span class="pre">FALSE</span></code> respectively, is returned in <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.14: </span>The name of the <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> is defined by the user.  Previously, it had
a fixed name <code class="docutils literal notranslate"><span class="pre">RESULT_VAR</span></code>.</p>
</div>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">try_compile(</span><span class="nv">&lt;resultVar&gt;</span><span class="w"> </span><span class="nv">&lt;bindir&gt;</span><span class="w"> </span><span class="o">&lt;</span><span class="nb">srcfile</span><span class="p">|</span><span class="no">SOURCES</span><span class="w"> </span><span class="nb">srcfile...</span><span class="o">&gt;</span><span class="w"></span>
...
variable).  The success or failure of the <code class="docutils literal notranslate"><span class="pre">try_compile</span></code>, i.e. <code class="docutils literal notranslate"><span class="pre">TRUE</span></code> or
<code class="docutils literal notranslate"><span class="pre">FALSE</span></code> respectively, is returned in <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code>.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.14: </span>The name of the <code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> is defined by the user.  Previously, it had
a fixed name <code class="docutils literal notranslate"><span class="pre">RESULT_VAR</span></code>.</p>
</div>
<p>In this form, one or more source files must be provided.  If
<span class="target" id="index-1-variable:CMAKE_TRY_COMPILE_TARGET_TYPE"></span><a class="reference internal" href="../variable/CMAKE_TRY_COMPILE_TARGET_TYPE.html#variable:CMAKE_TRY_COMPILE_TARGET_TYPE" title="CMAKE_TRY_COMPILE_TARGET_TYPE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_TRY_COMPILE_TARGET_TYPE</span></code></a> is unset or is set to <code class="docutils literal notranslate"><span class="pre">EXECUTABLE</span></code>,
the sources must include a definition for <code class="docutils literal notranslate"><span class="pre">main</span></code> and CMake will create a
<code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code> file to build the source(s) as an executable.
...
<p>In this version all files in <code class="docutils literal notranslate"><span class="pre">&lt;bindir&gt;/CMakeFiles/CMakeTmp</span></code> will be
cleaned automatically.  For debugging, <code class="docutils literal notranslate"><span class="pre">--debug-trycompile</span></code> can be
passed to <code class="docutils literal notranslate"><span class="pre">cmake</span></code> to avoid this clean.  However, multiple sequential
<code class="docutils literal notranslate"><span class="pre">try_compile</span></code> operations reuse this single output directory.  If you use
<code class="docutils literal notranslate"><span class="pre">--debug-trycompile</span></code>, you can only debug one <code class="docutils literal notranslate"><span class="pre">try_compile</span></code> call at a time.
The recommended procedure is to protect all <code class="docutils literal notranslate"><span class="pre">try_compile</span></code> calls in your
project by <code class="docutils literal notranslate"><span class="pre">if(NOT</span> <span class="pre">DEFINED</span> <span class="pre">&lt;resultVar&gt;)</span></code> logic, configure with cmake
all the way through once, then delete the cache entry associated with
the try_compile call of interest, and then re-run cmake again with
<code class="docutils literal notranslate"><span class="pre">--debug-trycompile</span></code>.</p>
</div>
...
<span class="target" id="index-0-command:try_compile"></span><a class="reference internal" href="#command:try_compile" title="try_compile"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">try_compile()</span></code></a> command.</p>
</div>
...
system customization cache variables are also propagated into the test project.</p>
</div>
</div>
</div>
