...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckVariableExists &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="command">
<dt id="command:check_variable_exists">
<code class="sig-name descname">CHECK_VARIABLE_EXISTS</code><a class="headerlink" href="#command:check_variable_exists" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">CHECK_VARIABLE_EXISTS(</span><span class="no">VAR</span><span class="w"> </span><span class="no">VARIABLE</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>VAR      - the name of the variable
VARIABLE - variable to store the result
           Will be created as an internal cache variable.
</pre></div>
</div>
<p>This macro is only for <code class="docutils literal notranslate"><span class="pre">C</span></code> variables.</p>
</dd></dl>
