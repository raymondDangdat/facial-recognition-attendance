...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ENVIRONMENT &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="DISABLED" href="DISABLED.html" />
...
<code class="docutils literal notranslate"><span class="pre">MYVAR=value</span></code> those environment variables will be defined while running
...
test is done.</p>
  ...
  <p class="topless"><a href="DISABLED.html"
                        title="previous chapter">DISABLED</a></p>
  <h4>Next topic</h4>
