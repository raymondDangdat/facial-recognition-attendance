...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindEXPAT &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="FindEnvModules" href="FindEnvModules.html" />
...
<p>Find the native Expat headers and library.
Expat is a stream-oriented XML parser library written in C.</p>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT::EXPAT</span></code></dt><dd><p>The Expat <code class="docutils literal notranslate"><span class="pre">expat</span></code> library, if found.</p>
</dd>
</dl>
</div>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_INCLUDE_DIRS</span></code></dt><dd><p>where to find expat.h, etc.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_LIBRARIES</span></code></dt><dd><p>the libraries to link against to use Expat.</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">EXPAT_FOUND</span></code></dt><dd><p>true if the Expat headers and libraries were found.</p>
</dd>
</dl>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#">FindEXPAT</a><ul>
...
<li><a class="reference internal" href="#result-variables">Result Variables</a></li>
  ...
  <p class="topless"><a href="FindEnvModules.html"
                        title="previous chapter">FindEnvModules</a></p>
  <h4>Next topic</h4>
