...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ANDROID_GUI &mdash; CMake 3.21.0 Documentation</title>
...
by the value of the <span class="target" id="index-0-variable:CMAKE_ANDROID_GUI"></span><a class="reference internal" href="../variable/CMAKE_ANDROID_GUI.html#variable:CMAKE_ANDROID_GUI" title="CMAKE_ANDROID_GUI"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_ANDROID_GUI</span></code></a> variable if it is set
when a target is created.</p>
<p>Add the <code class="docutils literal notranslate"><span class="pre">AndroidManifest.xml</span></code> source file explicitly to the
target <span class="target" id="index-0-command:add_executable"></span><a class="reference internal" href="../command/add_executable.html#command:add_executable" title="add_executable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_executable()</span></code></a> command invocation to specify the
