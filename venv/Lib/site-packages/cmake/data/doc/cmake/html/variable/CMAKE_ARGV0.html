...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_ARGV0 &mdash; CMake 3.21.0 Documentation</title>
...
<p>When run in <a class="reference internal" href="../manual/cmake.1.html#script-processing-mode"><span class="std std-ref">-P</span></a> script mode, CMake sets this
variable to the first command line argument.  It then also sets <code class="docutils literal notranslate"><span class="pre">CMAKE_ARGV1</span></code>,
<code class="docutils literal notranslate"><span class="pre">CMAKE_ARGV2</span></code>, ... and so on, up to the number of command line arguments
given.  See also <span class="target" id="index-0-variable:CMAKE_ARGC"></span><a class="reference internal" href="CMAKE_ARGC.html#variable:CMAKE_ARGC" title="CMAKE_ARGC"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_ARGC</span></code></a>.</p>
</div>
