...
<span id="envvar:<PackageName>_ROOT"></span><h1>&lt;PackageName&gt;_ROOT<a class="headerlink" href="#packagename-root" title="Permalink to this headline">¶</a></h1>
...
prefixes specified in the <code class="docutils literal notranslate"><span class="pre">Foo_ROOT</span></code> environment variable (if set).
