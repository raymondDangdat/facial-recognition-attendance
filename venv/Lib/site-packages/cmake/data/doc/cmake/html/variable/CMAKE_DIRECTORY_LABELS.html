...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_DIRECTORY_LABELS &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmake-directory-labels">
<span id="variable:CMAKE_DIRECTORY_LABELS"></span><h1>CMAKE_DIRECTORY_LABELS<a class="headerlink" href="#cmake-directory-labels" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.10.</span></p>
</div>
<p>Specify labels for the current directory.</p>
<p>This is used to initialize the <span class="target" id="index-0-prop_dir:LABELS"></span><a class="reference internal" href="../prop_dir/LABELS.html#prop_dir:LABELS" title="LABELS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">LABELS</span></code></a> directory property.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_DIRECTORY_LABELS.rst.txt"
