...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack DEB Generator &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpack-deb-generator">
<span id="cpack_gen:CPack DEB Generator"></span><h1>CPack DEB Generator<a class="headerlink" href="#cpack-deb-generator" title="Permalink to this headline">¶</a></h1>
...
specifics <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_XXX</span></code> variables.</p>
<p><code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_XXXX</span></code> variables may be used in order to have
...
<code class="sig-name descname">CPACK_DEB_COMPONENT_INSTALL</code><a class="headerlink" href="#variable:CPACK_DEB_COMPONENT_INSTALL" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_NAME</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_NAME" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_NAME">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_NAME</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_NAME" title="Permalink to this definition">¶</a></dt>
...
<p><span class="versionmodified added">New in version 3.5: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_NAME</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_FILE_NAME</code><a class="headerlink" href="#variable:CPACK_DEBIAN_FILE_NAME" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_FILE_NAME">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_FILE_NAME</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_FILE_NAME" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : <code class="docutils literal notranslate"><span class="pre">&lt;CPACK_PACKAGE_FILE_NAME&gt;[-&lt;component&gt;].deb</span></code></p></li>
</ul>
...
<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_EPOCH">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_EPOCH</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_EPOCH" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_VERSION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_VERSION" title="Permalink to this definition">¶</a></dt>
<dd><p>The Debian package version</p>
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : <span class="target" id="index-0-variable:CPACK_PACKAGE_VERSION"></span><a class="reference internal" href="../module/CPack.html#variable:CPACK_PACKAGE_VERSION" title="CPACK_PACKAGE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CPACK_PACKAGE_VERSION</span></code></a></p></li>
</ul>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_RELEASE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_RELEASE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.6.</span></p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_ARCHITECTURE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_ARCHITECTURE" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ARCHITECTURE">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ARCHITECTURE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_ARCHITECTURE" title="Permalink to this definition">¶</a></dt>
<dd><p>The Debian package architecture</p>
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : Output of <code class="docutils literal notranslate"><span class="pre">dpkg</span> <span class="pre">--print-architecture</span></code> (or <code class="docutils literal notranslate"><span class="pre">i386</span></code>
if <code class="docutils literal notranslate"><span class="pre">dpkg</span></code> is not found)</p></li>
</ul>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.6: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ARCHITECTURE</span></code> variables.</p>
</div>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_DEPENDS">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_DEPENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_DEPENDS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_DEPENDS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_DEPENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_DEPENDS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_DEPENDS</span></code> variables.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<p>Example:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_DEBIAN_PACKAGE_DEPENDS &quot;libc6 (&gt;= 2.3.1-6), libc6 (&lt; 2.4)&quot;)
</pre></div>
</div>
</dd></dl>
...
<code class="sig-name descname">CPACK_DEBIAN_ENABLE_COMPONENT_DEPENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_ENABLE_COMPONENT_DEPENDS" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.6.</span></p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_MAINTAINER</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_MAINTAINER" title="Permalink to this definition">¶</a></dt>
<dd><p>The Debian package maintainer</p>
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : <code class="docutils literal notranslate"><span class="pre">CPACK_PACKAGE_CONTACT</span></code></p></li>
</ul>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_DESCRIPTION">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_DESCRIPTION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_DESCRIPTION" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_COMPONENT_&lt;compName&gt;_DESCRIPTION</span></code> variables.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_DESCRIPTION</span></code> variables.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16: </span>The <code class="docutils literal notranslate"><span class="pre">CPACK_PACKAGE_DESCRIPTION_FILE</span></code> variable.</p>
</div>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_SECTION">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_SECTION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_SECTION" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SECTION">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SECTION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_SECTION" title="Permalink to this definition">¶</a></dt>
<dd><p>Set Section control field e.g. admin, devel, doc, ...</p>
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : &quot;devel&quot;</p></li>
</ul>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.5: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SECTION</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_ARCHIVE_TYPE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_ARCHIVE_TYPE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : &quot;gnutar&quot;</p></li>
</ul>
<p>Possible value is:</p>
<ul class="simple">
<li><p>gnutar</p></li>
</ul>
<div class="admonition note">
...
<code class="sig-name descname">CPACK_DEBIAN_COMPRESSION_TYPE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_COMPRESSION_TYPE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_PRIORITY</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_PRIORITY" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PRIORITY">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PRIORITY</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_PRIORITY" title="Permalink to this definition">¶</a></dt>
<dd><p>Set Priority control field e.g. required, important, standard, optional,
extra</p>
<ul class="simple">
<li><p>Mandatory : YES</p></li>
<li><p>Default   : &quot;optional&quot;</p></li>
</ul>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.5: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PRIORITY</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_HOMEPAGE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_HOMEPAGE" title="Permalink to this definition">¶</a></dt>
...
<ul class="simple">
<li><p>Mandatory : NO</p></li>
<li><p>Default   : <span class="target" id="index-0-variable:CMAKE_PROJECT_HOMEPAGE_URL"></span><a class="reference internal" href="../variable/CMAKE_PROJECT_HOMEPAGE_URL.html#variable:CMAKE_PROJECT_HOMEPAGE_URL" title="CMAKE_PROJECT_HOMEPAGE_URL"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_PROJECT_HOMEPAGE_URL</span></code></a></p></li>
</ul>
<div class="versionadded">
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_SHLIBDEPS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_SHLIBDEPS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SHLIBDEPS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SHLIBDEPS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_SHLIBDEPS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.3: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SHLIBDEPS</span></code> variables.</p>
</div>
<div class="versionadded">
...
<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_SHLIBDEPS_PRIVATE_DIRS">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_SHLIBDEPS_PRIVATE_DIRS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_SHLIBDEPS_PRIVATE_DIRS" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_DEBUG</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_DEBUG" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_PREDEPENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_PREDEPENDS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PREDEPENDS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PREDEPENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_PREDEPENDS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PREDEPENDS</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_ENHANCES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_ENHANCES" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ENHANCES">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ENHANCES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_ENHANCES" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_ENHANCES</span></code> variables.</p>
</div>
<p>See <a class="reference external" href="http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps">http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps</a></p>
</dd></dl>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_BREAKS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_BREAKS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_BREAKS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_BREAKS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_BREAKS" title="Permalink to this definition">¶</a></dt>
<dd><p>Sets the <cite>Breaks</cite> field of the Debian package.
When a binary package (P) declares that it breaks other packages (B),
<code class="docutils literal notranslate"><span class="pre">dpkg</span></code> will not allow the package (P) which declares <cite>Breaks</cite> be
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_BREAKS</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_CONFLICTS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_CONFLICTS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONFLICTS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONFLICTS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_CONFLICTS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONFLICTS</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_PROVIDES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_PROVIDES" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PROVIDES">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PROVIDES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_PROVIDES" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_PROVIDES</span></code> variables.</p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_REPLACES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_REPLACES" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_REPLACES">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_REPLACES</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_REPLACES" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_REPLACES</span></code> variables.</p>
</div>
<p>See <a class="reference external" href="http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps">http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps</a></p>
</dd></dl>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_RECOMMENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_RECOMMENDS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_RECOMMENDS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_RECOMMENDS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_RECOMMENDS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_RECOMMENDS</span></code> variables.</p>
</div>
<p>See <a class="reference external" href="http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps">http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps</a></p>
</dd></dl>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_SUGGESTS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_SUGGESTS" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SUGGESTS">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SUGGESTS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_SUGGESTS" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SUGGESTS</span></code> variables.</p>
</div>
<p>See <a class="reference external" href="http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps">http://www.debian.org/doc/debian-policy/ch-relationships.html#s-binarydeps</a></p>
</dd></dl>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_GENERATE_SHLIBS</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_GENERATE_SHLIBS" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.6.</span></p>
</div>
<ul class="simple">
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_GENERATE_SHLIBS_POLICY</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_GENERATE_SHLIBS_POLICY" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.6.</span></p>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONTROL_EXTRA">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONTROL_EXTRA</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_CONTROL_EXTRA" title="Permalink to this definition">¶</a></dt>
...
<p>Usage:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA
    &quot;${CMAKE_CURRENT_SOURCE_DIR}/prerm;${CMAKE_CURRENT_SOURCE_DIR}/postrm&quot;)
</pre></div>
</div>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.4: </span>Per-component <code class="docutils literal notranslate"><span class="pre">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONTROL_EXTRA</span></code> variables.</p>
</div>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_DEBIAN_PACKAGE_CONTROL_STRICT_PERMISSION">
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_CONTROL_STRICT_PERMISSION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_CONTROL_STRICT_PERMISSION" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONTROL_STRICT_PERMISSION">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_CONTROL_STRICT_PERMISSION</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_CONTROL_STRICT_PERMISSION" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<p>Usage:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>set(CPACK_DEBIAN_PACKAGE_CONTROL_STRICT_PERMISSION TRUE)
</pre></div>
</div>
...
<code class="sig-name descname">CPACK_DEBIAN_PACKAGE_SOURCE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_PACKAGE_SOURCE" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SOURCE">
<code class="sig-name descname">CPACK_DEBIAN_&lt;COMPONENT&gt;_PACKAGE_SOURCE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<COMPONENT>_PACKAGE_SOURCE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<dl class="variable">
<dt id="variable:CPACK_DEBIAN_DEBUGINFO_PACKAGE">
<code class="sig-name descname">CPACK_DEBIAN_DEBUGINFO_PACKAGE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_DEBUGINFO_PACKAGE" title="Permalink to this definition">¶</a></dt>
<dt id="variable:CPACK_DEBIAN_&lt;component&gt;_DEBUGINFO_PACKAGE">
<code class="sig-name descname">CPACK_DEBIAN_&lt;component&gt;_DEBUGINFO_PACKAGE</code><a class="headerlink" href="#variable:CPACK_DEBIAN_<component>_DEBUGINFO_PACKAGE" title="Permalink to this definition">¶</a></dt>
...
<div class="section" id="building-debian-packages-on-windows">
<h2>Building Debian packages on Windows<a class="headerlink" href="#building-debian-packages-on-windows" title="Permalink to this headline">¶</a></h2>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.10.</span></p>
</div>
...
<div class="section" id="reproducible-packages">
<h2>Reproducible packages<a class="headerlink" href="#reproducible-packages" title="Permalink to this headline">¶</a></h2>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.13.</span></p>
</div>
<p>The environment variable <code class="docutils literal notranslate"><span class="pre">SOURCE_DATE_EPOCH</span></code> may be set to a UNIX
