...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0002 &mdash; CMake 3.21.0 Documentation</title>
...
<span class="target" id="index-0-prop_tgt:OUTPUT_NAME"></span><a class="reference internal" href="../prop_tgt/OUTPUT_NAME.html#prop_tgt:OUTPUT_NAME" title="OUTPUT_NAME"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">OUTPUT_NAME</span></code></a> target property to create two targets with the same
physical name while keeping logical names distinct.  Custom targets
must simply have globally unique names (unless one uses the global
property <span class="target" id="index-0-prop_gbl:ALLOW_DUPLICATE_CUSTOM_TARGETS"></span><a class="reference internal" href="../prop_gbl/ALLOW_DUPLICATE_CUSTOM_TARGETS.html#prop_gbl:ALLOW_DUPLICATE_CUSTOM_TARGETS" title="ALLOW_DUPLICATE_CUSTOM_TARGETS"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">ALLOW_DUPLICATE_CUSTOM_TARGETS</span></code></a> with a Makefiles generator).</p>
