...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPackFreeBSD &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpackfreebsd">
<span id="module:CPackFreeBSD"></span><h1>CPackFreeBSD<a class="headerlink" href="#cpackfreebsd" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.10.</span></p>
</div>
<p>The documentation for the CPack FreeBSD generator has moved here: <span class="target" id="index-0-cpack_gen:CPack FreeBSD Generator"></span><a class="reference internal" href="../cpack_gen/freebsd.html#cpack_gen:CPack FreeBSD Generator" title="CPack FreeBSD Generator"><code class="xref cmake cmake-cpack_gen docutils literal notranslate"><span class="pre">CPack</span> <span class="pre">FreeBSD</span> <span class="pre">Generator</span></code></a></p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CPackFreeBSD.rst.txt"
