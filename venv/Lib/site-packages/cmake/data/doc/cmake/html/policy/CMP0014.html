...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0014 &mdash; CMake 3.21.0 Documentation</title>
...
<p>Input directories must have <code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>.</p>
<p>CMake versions before 2.8 silently ignored missing <code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>
files in directories referenced by <span class="target" id="index-0-command:add_subdirectory"></span><a class="reference internal" href="../command/add_subdirectory.html#command:add_subdirectory" title="add_subdirectory"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_subdirectory()</span></code></a> or  <span class="target" id="index-0-command:subdirs"></span><a class="reference internal" href="../command/subdirs.html#command:subdirs" title="subdirs"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">subdirs()</span></code></a>,
treating them as if present but empty.  In CMake 2.8.0 and above this
<span class="target" id="index-0-command:cmake_policy"></span><a class="reference internal" href="../command/cmake_policy.html#command:cmake_policy" title="cmake_policy"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cmake_policy()</span></code></a> determines whether or not the case is an error.
The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy is to silently ignore the problem.
The <code class="docutils literal notranslate"><span class="pre">NEW</span></code> behavior for this policy is to report an error.</p>
