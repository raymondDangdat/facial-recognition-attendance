...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VS_SHADER_MODEL &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="VS_SHADER_OBJECT_FILE_NAME" href="VS_SHADER_OBJECT_FILE_NAME.html" />
...
<p>Specifies the shader model of a <code class="docutils literal notranslate"><span class="pre">.hlsl</span></code> source file. Some shader types can
only be used with recent shader models</p>
  ...
  <p class="topless"><a href="VS_SHADER_OBJECT_FILE_NAME.html"
                        title="next chapter">VS_SHADER_OBJECT_FILE_NAME</a></p>
