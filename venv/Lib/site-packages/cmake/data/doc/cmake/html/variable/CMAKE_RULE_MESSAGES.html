...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_RULE_MESSAGES &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmake-rule-messages">
<span id="variable:CMAKE_RULE_MESSAGES"></span><h1>CMAKE_RULE_MESSAGES<a class="headerlink" href="#cmake-rule-messages" title="Permalink to this headline">¶</a></h1>
...
<p>If set in the cache it is used to initialize the value of the <span class="target" id="index-0-prop_gbl:RULE_MESSAGES"></span><a class="reference internal" href="../prop_gbl/RULE_MESSAGES.html#prop_gbl:RULE_MESSAGES" title="RULE_MESSAGES"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">RULE_MESSAGES</span></code></a> property.
Users may disable the option in their local build tree to disable granular messages
and report only as each target completes in Makefile builds.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_RULE_MESSAGES.rst.txt"
