...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_LINK_DIRECTORIES &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="INTERFACE_LINK_DEPENDS" href="INTERFACE_LINK_DEPENDS.html" />
  ...
  <div class="section" id="interface-link-directories">
<span id="prop_tgt:INTERFACE_LINK_DIRECTORIES"></span><h1>INTERFACE_LINK_DIRECTORIES<a class="headerlink" href="#interface-link-directories" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.13.</span></p>
</div>
<p>List of public link directories requirements for a library.</p>
<p>Targets may populate this property to publish the link directories
required to compile against the headers for the target.  The <span class="target" id="index-0-command:target_link_directories"></span><a class="reference internal" href="../command/target_link_directories.html#command:target_link_directories" title="target_link_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_link_directories()</span></code></a>
...
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INTERFACE_LINK_DIRECTORIES</span></code> may use &quot;generator expressions&quot;
...
-manual for more on defining buildsystem properties.</p>
  ...
  <p class="topless"><a href="INTERFACE_LINK_DEPENDS.html"
                        title="previous chapter">INTERFACE_LINK_DEPENDS</a></p>
  <h4>Next topic</h4>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/prop_tgt/INTERFACE_LINK_DIRECTORIES.rst.txt"
