...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_SCRIPT_MODE_FILE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_RULE_MESSAGES" href="CMAKE_RULE_MESSAGES.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_RULE_MESSAGES.html" title="CMAKE_RULE_MESSAGES"
...
<p>Full path to the <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> <code class="docutils literal notranslate"><span class="pre">-P</span></code> script file currently being
processed.</p>
<p>When run in <span class="target" id="index-1-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> <code class="docutils literal notranslate"><span class="pre">-P</span></code> script mode, CMake sets this variable to
the full path of the script file.  When run to configure a <code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>
file, this variable is not set.</p>
  ...
  <p class="topless"><a href="CMAKE_RULE_MESSAGES.html"
                        title="previous chapter">CMAKE_RULE_MESSAGES</a></p>
  <h4>Next topic</h4>
