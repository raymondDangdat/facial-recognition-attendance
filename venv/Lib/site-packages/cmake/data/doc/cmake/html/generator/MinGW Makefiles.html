...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>MinGW Makefiles &mdash; CMake 3.21.0 Documentation</title>
...
<p>Generates makefiles for use with <code class="docutils literal notranslate"><span class="pre">mingw32-make</span></code> under a Windows command
prompt.</p>
<p>Use this generator under a Windows command prompt with
MinGW (Minimalist GNU for Windows) in the <code class="docutils literal notranslate"><span class="pre">PATH</span></code>
and using <code class="docutils literal notranslate"><span class="pre">mingw32-make</span></code> as the build tool.  The generated makefiles use
<code class="docutils literal notranslate"><span class="pre">cmd.exe</span></code> as the shell to launch build rules.  They are not compatible with
MSYS or a unix shell.</p>
<p>To build under the MSYS shell, use the <span class="target" id="index-0-generator:MSYS Makefiles"></span><a class="reference internal" href="MSYS Makefiles.html#generator:MSYS Makefiles" title="MSYS Makefiles"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">MSYS</span> <span class="pre">Makefiles</span></code></a> generator.</p>
</div>
