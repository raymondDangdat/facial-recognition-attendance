...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VS_DESKTOP_EXTENSIONS_VERSION &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="VS_DOTNET_DOCUMENTATION_FILE" href="VS_DOTNET_DOCUMENTATION_FILE.html" />
...
target. For example <code class="docutils literal notranslate"><span class="pre">10.0.10240.0</span></code>. If the value is not specified, the Desktop
...
<span class="target" id="index-0-variable:CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION"></span><a class="reference internal" href="../variable/CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION.html#variable:CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION" title="CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION</span></code></a> variable.</p>
  ...
  <p class="topless"><a href="VS_DOTNET_DOCUMENTATION_FILE.html"
                        title="next chapter">VS_DOTNET_DOCUMENTATION_FILE</a></p>
