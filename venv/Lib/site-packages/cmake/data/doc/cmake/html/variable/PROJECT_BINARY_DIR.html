...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>PROJECT_BINARY_DIR &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="PROJECT_DESCRIPTION" href="PROJECT_DESCRIPTION.html" />
...
<p>This is the binary directory of the most recent <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> command.</p>
</div>
  ...
  <p class="topless"><a href="PROJECT_DESCRIPTION.html"
                        title="next chapter">PROJECT_DESCRIPTION</a></p>
