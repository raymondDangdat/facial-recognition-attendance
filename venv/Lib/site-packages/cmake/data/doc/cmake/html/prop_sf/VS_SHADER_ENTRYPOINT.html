...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VS_SHADER_ENTRYPOINT &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="VS_SHADER_ENABLE_DEBUG" href="VS_SHADER_ENABLE_DEBUG.html" />
...
<p>Specifies the name of the entry point for the shader of a <code class="docutils literal notranslate"><span class="pre">.hlsl</span></code> source
file.</p>
</div>
  ...
  <p class="topless"><a href="VS_SHADER_ENABLE_DEBUG.html"
                        title="previous chapter">VS_SHADER_ENABLE_DEBUG</a></p>
  <h4>Next topic</h4>
