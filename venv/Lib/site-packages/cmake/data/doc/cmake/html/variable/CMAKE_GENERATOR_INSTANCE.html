...
<ul class="simple">
<li><p>For the <span class="target" id="index-0-generator:Visual Studio 15 2017"></span><a class="reference internal" href="../generator/Visual Studio 15 2017.html#generator:Visual Studio 15 2017" title="Visual Studio 15 2017"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">15</span> <span class="pre">2017</span></code></a> generator (and above)
this specifies the absolute path to the VS installation directory
of the selected VS instance.</p></li>
</ul>
<p>See native build system documentation for allowed instance values.</p>
</div>
