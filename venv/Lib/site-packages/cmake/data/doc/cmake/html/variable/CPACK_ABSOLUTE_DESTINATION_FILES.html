...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPACK_ABSOLUTE_DESTINATION_FILES &mdash; CMake 3.21.0 Documentation</title>
...
<p>List of files which have been installed using an <code class="docutils literal notranslate"><span class="pre">ABSOLUTE</span> <span class="pre">DESTINATION</span></code> path.</p>
<p>This variable is a Read-Only variable which is set internally by CPack
during installation and before packaging using
<span class="target" id="index-0-variable:CMAKE_ABSOLUTE_DESTINATION_FILES"></span><a class="reference internal" href="CMAKE_ABSOLUTE_DESTINATION_FILES.html#variable:CMAKE_ABSOLUTE_DESTINATION_FILES" title="CMAKE_ABSOLUTE_DESTINATION_FILES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_ABSOLUTE_DESTINATION_FILES</span></code></a> defined in <code class="docutils literal notranslate"><span class="pre">cmake_install.cmake</span></code>
scripts.  The value can be used within CPack project configuration
file and/or <code class="docutils literal notranslate"><span class="pre">CPack&lt;GEN&gt;.cmake</span></code> file of <code class="docutils literal notranslate"><span class="pre">&lt;GEN&gt;</span></code> generator.</p>
</div>
