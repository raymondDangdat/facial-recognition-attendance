...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>target_sources &mdash; CMake 3.21.0 Documentation</title>
...
specify the scope of the items following them.  <code class="docutils literal notranslate"><span class="pre">PRIVATE</span></code> and <code class="docutils literal notranslate"><span class="pre">PUBLIC</span></code>
items will populate the <span class="target" id="index-0-prop_tgt:SOURCES"></span><a class="reference internal" href="../prop_tgt/SOURCES.html#prop_tgt:SOURCES" title="SOURCES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">SOURCES</span></code></a> property of
<code class="docutils literal notranslate"><span class="pre">&lt;target&gt;</span></code>, which are used when building the target itself.
...
<code class="docutils literal notranslate"><span class="pre">&lt;target&gt;</span></code> append items in the order called. The targets created by
<span class="target" id="index-1-command:add_custom_target"></span><a class="reference internal" href="add_custom_target.html#command:add_custom_target" title="add_custom_target"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_custom_target()</span></code></a> can only have <code class="docutils literal notranslate"><span class="pre">PRIVATE</span></code> scope.</p>
<div class="versionadded">
...
<p>Arguments to <code class="docutils literal notranslate"><span class="pre">target_sources</span></code> may use &quot;generator expressions&quot;
