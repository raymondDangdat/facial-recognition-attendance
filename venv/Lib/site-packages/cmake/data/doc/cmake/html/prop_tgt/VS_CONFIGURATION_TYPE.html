...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VS_CONFIGURATION_TYPE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="VS_DEBUGGER_COMMAND" href="VS_DEBUGGER_COMMAND.html" />
...
<p>Sets the <code class="docutils literal notranslate"><span class="pre">ConfigurationType</span></code> attribute for a generated Visual Studio project.
...
target type (e.g. <code class="docutils literal notranslate"><span class="pre">StaticLibrary</span></code>, <code class="docutils literal notranslate"><span class="pre">Application</span></code>, ...).</p>
<p>Supported on <a class="reference internal" href="../manual/cmake-generators.7.html#visual-studio-generators"><span class="std std-ref">Visual Studio Generators</span></a> for VS 2010 and higher.</p>
  ...
  <p class="topless"><a href="VS_DEBUGGER_COMMAND.html"
                        title="next chapter">VS_DEBUGGER_COMMAND</a></p>
