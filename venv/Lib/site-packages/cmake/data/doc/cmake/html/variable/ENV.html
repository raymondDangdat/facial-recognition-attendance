...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ENV &mdash; CMake 3.21.0 Documentation</title>
...
<p>Use the syntax <code class="docutils literal notranslate"><span class="pre">$ENV{VAR}</span></code> to read environment variable <code class="docutils literal notranslate"><span class="pre">VAR</span></code>.</p>
<p>To test whether an environment variable is defined, use the signature
<code class="docutils literal notranslate"><span class="pre">if(DEFINED</span> <span class="pre">ENV{&lt;name&gt;})</span></code> of the <span class="target" id="index-0-command:if"></span><a class="reference internal" href="../command/if.html#command:if" title="if"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">if()</span></code></a> command.</p>
...
write or remove environment variables.</p>
</div>
