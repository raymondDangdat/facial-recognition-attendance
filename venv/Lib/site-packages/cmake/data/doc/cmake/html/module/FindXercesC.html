...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindXercesC &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC::XercesC</span></code></dt><dd><p>The Xerces-C++ <code class="docutils literal notranslate"><span class="pre">xerces-c</span></code> library, if found.</p>
</dd>
</dl>
</div>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_FOUND</span></code></dt><dd><p>true if the Xerces headers and libraries were found</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_VERSION</span></code></dt><dd><p>Xerces release version</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_INCLUDE_DIRS</span></code></dt><dd><p>the directory containing the Xerces headers</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_LIBRARIES</span></code></dt><dd><p>Xerces libraries to be linked</p>
</dd>
</dl>
</div>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_INCLUDE_DIR</span></code></dt><dd><p>the directory containing the Xerces headers</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">XercesC_LIBRARY</span></code></dt><dd><p>the Xerces library</p>
</dd>
</dl>
<div class="versionadded">
