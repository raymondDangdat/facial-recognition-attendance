...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>SKIP_REGULAR_EXPRESSION &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="skip-regular-expression">
<span id="prop_test:SKIP_REGULAR_EXPRESSION"></span><h1>SKIP_REGULAR_EXPRESSION<a class="headerlink" href="#skip-regular-expression" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16.</span></p>
</div>
<p>If the output matches this regular expression the test will be marked as skipped.</p>
<p>If set, if the output matches one of specified regular expressions,
the test will be marked as skipped.  Example:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set_property(</span><span class="no">TEST</span><span class="w"> </span><span class="nb">mytest</span><span class="w"> </span><span class="no">PROPERTY</span><span class="w"></span>
<span class="w">  </span><span class="no">SKIP_REGULAR_EXPRESSION</span><span class="w"> </span><span class="s">&quot;[^a-z]Skip&quot;</span><span class="w"> </span><span class="s">&quot;SKIP&quot;</span><span class="w"> </span><span class="s">&quot;Skipped&quot;</span><span class="w"></span>
