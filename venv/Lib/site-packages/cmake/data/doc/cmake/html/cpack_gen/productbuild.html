...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack productbuild Generator &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpack-productbuild-generator">
<span id="cpack_gen:CPack productbuild Generator"></span><h1>CPack productbuild Generator<a class="headerlink" href="#cpack-productbuild-generator" title="Permalink to this headline">¶</a></h1>
...
<code class="sig-name descname">CPACK_COMMAND_PRODUCTBUILD</code><a class="headerlink" href="#variable:CPACK_COMMAND_PRODUCTBUILD" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_PRODUCTBUILD_IDENTITY_NAME</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_IDENTITY_NAME" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_PRODUCTBUILD_KEYCHAIN_PATH</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_KEYCHAIN_PATH" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.8.</span></p>
</div>
...
<code class="sig-name descname">CPACK_COMMAND_PKGBUILD</code><a class="headerlink" href="#variable:CPACK_COMMAND_PKGBUILD" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_PKGBUILD_IDENTITY_NAME</code><a class="headerlink" href="#variable:CPACK_PKGBUILD_IDENTITY_NAME" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.8.</span></p>
</div>
<p>Adds a digital signature to the resulting package.</p>
...
<code class="sig-name descname">CPACK_PKGBUILD_KEYCHAIN_PATH</code><a class="headerlink" href="#variable:CPACK_PKGBUILD_KEYCHAIN_PATH" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.8.</span></p>
</div>
<p>Specify a specific keychain to search for the signing identity.</p>
...
<dl class="variable">
<dt id="variable:CPACK_PREFLIGHT_&lt;COMP&gt;_SCRIPT">
<code class="sig-name descname">CPACK_PREFLIGHT_&lt;COMP&gt;_SCRIPT</code><a class="headerlink" href="#variable:CPACK_PREFLIGHT_<COMP>_SCRIPT" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_POSTFLIGHT_&lt;COMP&gt;_SCRIPT">
<code class="sig-name descname">CPACK_POSTFLIGHT_&lt;COMP&gt;_SCRIPT</code><a class="headerlink" href="#variable:CPACK_POSTFLIGHT_<COMP>_SCRIPT" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_RESOURCES_DIR">
<code class="sig-name descname">CPACK_PRODUCTBUILD_RESOURCES_DIR</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_RESOURCES_DIR" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
installer.</p>
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_ALIGNMENT">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_ALIGNMENT</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_ALIGNMENT" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_SCALING">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_SCALING</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_SCALING" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_MIME_TYPE">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_MIME_TYPE</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_MIME_TYPE" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_UTI">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_UTI</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_UTI" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_ALIGNMENT">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_ALIGNMENT</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_ALIGNMENT" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_SCALING">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_SCALING</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_SCALING" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_MIME_TYPE">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_MIME_TYPE</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_MIME_TYPE" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_UTI">
<code class="sig-name descname">CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_UTI</code><a class="headerlink" href="#variable:CPACK_PRODUCTBUILD_BACKGROUND_DARKAQUA_UTI" title="Permalink to this definition">¶</a></dt>
