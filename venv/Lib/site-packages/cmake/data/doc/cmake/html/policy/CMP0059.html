...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0059 &mdash; CMake 3.21.0 Documentation</title>
...
<p>Do not treat <code class="docutils literal notranslate"><span class="pre">DEFINITIONS</span></code> as a built-in directory property.</p>
<p>CMake 3.3 and above no longer make a list of definitions available through
the <span class="target" id="index-0-prop_dir:DEFINITIONS"></span><a class="reference internal" href="../prop_dir/DEFINITIONS.html#prop_dir:DEFINITIONS" title="DEFINITIONS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">DEFINITIONS</span></code></a> directory property.  The
<span class="target" id="index-0-prop_dir:COMPILE_DEFINITIONS"></span><a class="reference internal" href="../prop_dir/COMPILE_DEFINITIONS.html#prop_dir:COMPILE_DEFINITIONS" title="COMPILE_DEFINITIONS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">COMPILE_DEFINITIONS</span></code></a> directory property may be used instead.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy is to provide the list of flags given
so far to the <span class="target" id="index-0-command:add_definitions"></span><a class="reference internal" href="../command/add_definitions.html#command:add_definitions" title="add_definitions"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_definitions()</span></code></a> command.  The <code class="docutils literal notranslate"><span class="pre">NEW</span></code> behavior is
