...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>BUILDSYSTEM_TARGETS &mdash; CMake 3.21.0 Documentation</title>
...
<a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a> of buildsystem targets added in the
...
of a target, suitable to pass to the <span class="target" id="index-0-command:get_property"></span><a class="reference internal" href="../command/get_property.html#command:get_property" title="get_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">get_property()</span></code></a> command
<code class="docutils literal notranslate"><span class="pre">TARGET</span></code> option.</p>
<p>See also the <span class="target" id="index-0-prop_dir:IMPORTED_TARGETS"></span><a class="reference internal" href="IMPORTED_TARGETS.html#prop_dir:IMPORTED_TARGETS" title="IMPORTED_TARGETS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">IMPORTED_TARGETS</span></code></a> directory property.</p>
</div>
