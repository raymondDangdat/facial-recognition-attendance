...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckOBJCSourceCompiles &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CheckOBJCSourceRuns" href="CheckOBJCSourceRuns.html" />
    <link rel="prev" title="CheckOBJCCompilerFlag" href="CheckOBJCCompilerFlag.html" />
  ...
  <div class="section" id="checkobjcsourcecompiles">
<span id="module:CheckOBJCSourceCompiles"></span><h1>CheckOBJCSourceCompiles<a class="headerlink" href="#checkobjcsourcecompiles" title="Permalink to this headline">¶</a></h1>
...
<dl class="command">
<dt id="command:check_objc_source_compiles">
<code class="sig-name descname">check_objc_source_compiles</code><a class="headerlink" href="#command:check_objc_source_compiles" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_objc_source_compiles(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
...
<p>Check that the source supplied in <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> can be compiled as a Objectie-C source
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_objc_source_compiles()</span></code>:</p>
<dl class="simple">
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckOBJCCompilerFlag.html"
                        title="previous chapter">CheckOBJCCompilerFlag</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="CheckOBJCSourceRuns.html"
                        title="next chapter">CheckOBJCSourceRuns</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CheckOBJCSourceCompiles.rst.txt"
