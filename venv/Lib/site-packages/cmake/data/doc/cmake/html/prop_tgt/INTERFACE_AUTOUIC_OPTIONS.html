...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_AUTOUIC_OPTIONS &mdash; CMake 3.21.0 Documentation</title>
...
required to use when invoking <code class="docutils literal notranslate"><span class="pre">uic</span></code>.  Consuming targets can add entries to their
own <span class="target" id="index-0-prop_tgt:AUTOUIC_OPTIONS"></span><a class="reference internal" href="AUTOUIC_OPTIONS.html#prop_tgt:AUTOUIC_OPTIONS" title="AUTOUIC_OPTIONS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOUIC_OPTIONS</span></code></a> property such as
<code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PROPERTY:foo,INTERFACE_AUTOUIC_OPTIONS&gt;</span></code> to use the uic options
specified in the interface of <code class="docutils literal notranslate"><span class="pre">foo</span></code>. This is done automatically by
