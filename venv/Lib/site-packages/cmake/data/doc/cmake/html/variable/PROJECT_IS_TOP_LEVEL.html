...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>PROJECT_IS_TOP_LEVEL &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="project-is-top-level">
...
<p>A boolean variable indicating whether <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> was called in a top
