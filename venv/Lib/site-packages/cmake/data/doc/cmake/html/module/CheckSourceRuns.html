...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckSourceRuns &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CheckSourceCompiles" href="CheckSourceCompiles.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CheckSourceCompiles.html" title="CheckSourceCompiles"
  ...
  <div class="section" id="checksourceruns">
<span id="module:CheckSourceRuns"></span><h1>CheckSourceRuns<a class="headerlink" href="#checksourceruns" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.19.</span></p>
</div>
<p>Check if given source compiles and links into an executable and can
subsequently be run.</p>
<dl class="command">
<dt id="command:check_source_runs">
<code class="sig-name descname">check_source_runs</code><a class="headerlink" href="#command:check_source_runs" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_source_runs(</span><span class="nv">&lt;lang&gt;</span><span class="w"> </span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
...
The <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> must contain at least a <code class="docutils literal notranslate"><span class="pre">main()</span></code> function. If the <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code>
could be built and run successfully, the internal cache variable specified by
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> will be set to 1, otherwise it will be set to an value that
evaluates to boolean false (e.g. an empty string or an error message).</p>
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckSourceCompiles.html"
                        title="previous chapter">CheckSourceCompiles</a></p>
  <h4>Next topic</h4>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CheckSourceRuns.rst.txt"
