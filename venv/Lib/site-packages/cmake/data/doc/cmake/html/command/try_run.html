...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>try_run &mdash; CMake 3.21.0 Documentation</title>
...
<p><span class="versionmodified added">New in version 3.14: </span>The names of the result variables <code class="docutils literal notranslate"><span class="pre">&lt;runResultVar&gt;</span></code> and
<code class="docutils literal notranslate"><span class="pre">&lt;compileResultVar&gt;</span></code> are defined by the user.  Previously, they had
fixed names <code class="docutils literal notranslate"><span class="pre">RUN_RESULT_VAR</span></code> and <code class="docutils literal notranslate"><span class="pre">COMPILE_RESULT_VAR</span></code>.</p>
</div>
<p>The options are:</p>
<dl>
