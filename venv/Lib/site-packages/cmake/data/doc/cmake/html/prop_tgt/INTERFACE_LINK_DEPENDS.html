...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_LINK_DEPENDS &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="interface-link-depends">
<span id="prop_tgt:INTERFACE_LINK_DEPENDS"></span><h1>INTERFACE_LINK_DEPENDS<a class="headerlink" href="#interface-link-depends" title="Permalink to this headline">¶</a></h1>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set_property(</span><span class="no">TARGET</span><span class="w"> </span><span class="nb">mylib</span><span class="w"> </span><span class="no">PROPERTY</span><span class="w"> </span><span class="no">INTERFACE_LINK_DEPENDS</span><span class="w"></span>
<span class="w">  </span><span class="o">$&lt;</span><span class="no">BUILD_INTERFACE</span><span class="o">:${</span><span class="nt">CMAKE_CURRENT_SOURCE_DIR</span><span class="o">}</span><span class="na">/mylinkscript</span><span class="o">&gt;</span><span class="w"></span>
