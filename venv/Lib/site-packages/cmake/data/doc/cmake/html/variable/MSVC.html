...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>MSVC &mdash; CMake 3.21.0 Documentation</title>
...
<p>Set to <code class="docutils literal notranslate"><span class="pre">true</span></code> when the compiler is some version of Microsoft Visual C++
or another compiler simulating the Visual C++ <code class="docutils literal notranslate"><span class="pre">cl</span></code> command-line syntax.</p>
<p>See also the <span class="target" id="index-0-variable:MSVC_VERSION"></span><a class="reference internal" href="MSVC_VERSION.html#variable:MSVC_VERSION" title="MSVC_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">MSVC_VERSION</span></code></a> variable.</p>
</div>
