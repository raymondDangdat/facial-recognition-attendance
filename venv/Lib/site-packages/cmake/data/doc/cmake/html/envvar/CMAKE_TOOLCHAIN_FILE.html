...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_TOOLCHAIN_FILE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="DESTDIR" href="DESTDIR.html" />
...
<span id="envvar:CMAKE_TOOLCHAIN_FILE"></span><h1>CMAKE_TOOLCHAIN_FILE<a class="headerlink" href="#cmake-toolchain-file" title="Permalink to this headline">¶</a></h1>
...
<p>The <code class="docutils literal notranslate"><span class="pre">CMAKE_TOOLCHAIN_FILE</span></code> environment variable specifies a default value
for the <span class="target" id="index-0-variable:CMAKE_TOOLCHAIN_FILE"></span><a class="reference internal" href="../variable/CMAKE_TOOLCHAIN_FILE.html#variable:CMAKE_TOOLCHAIN_FILE" title="CMAKE_TOOLCHAIN_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_TOOLCHAIN_FILE</span></code></a> variable when there is no explicit
...
as <span class="target" id="index-1-variable:CMAKE_TOOLCHAIN_FILE"></span><a class="reference internal" href="../variable/CMAKE_TOOLCHAIN_FILE.html#variable:CMAKE_TOOLCHAIN_FILE" title="CMAKE_TOOLCHAIN_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_TOOLCHAIN_FILE</span></code></a>.</p>
  ...
  <p class="topless"><a href="DESTDIR.html"
                        title="next chapter">DESTDIR</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/envvar/CMAKE_TOOLCHAIN_FILE.rst.txt"
