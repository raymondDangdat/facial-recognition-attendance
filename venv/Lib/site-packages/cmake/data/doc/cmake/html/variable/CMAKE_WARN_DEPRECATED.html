...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_WARN_DEPRECATED &mdash; CMake 3.21.0 Documentation</title>
...
<p>If not <code class="docutils literal notranslate"><span class="pre">FALSE</span></code>, use of deprecated functionality will issue warnings.
If this variable is not set, CMake behaves as if it were set to <code class="docutils literal notranslate"><span class="pre">TRUE</span></code>.</p>
<p>When running <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a>, this option can be enabled with the
<code class="docutils literal notranslate"><span class="pre">-Wdeprecated</span></code> option, or disabled with the <code class="docutils literal notranslate"><span class="pre">-Wno-deprecated</span></code> option.</p>
</div>
