...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_OSX_SYSROOT &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_PCH_WARN_INVALID" href="CMAKE_PCH_WARN_INVALID.html" />
...
<p>Specify the location or name of the macOS platform SDK to be used.
CMake uses this value to compute the value of the <code class="docutils literal notranslate"><span class="pre">-isysroot</span></code> flag
or equivalent and to help the <code class="docutils literal notranslate"><span class="pre">find_*</span></code> commands locate files in
the SDK.</p>
...
<p>This variable is ignored on platforms other than Apple.</p>
  ...
  <p class="topless"><a href="CMAKE_PCH_WARN_INVALID.html"
                        title="next chapter">CMAKE_PCH_WARN_INVALID</a></p>
