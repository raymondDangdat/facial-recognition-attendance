...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckFortranFunctionExists &mdash; CMake 3.21.0 Documentation</title>
...
<p>Check if a Fortran function exists.</p>
<dl class="command">
<dt id="command:check_fortran_function_exists">
<code class="sig-name descname">CHECK_FORTRAN_FUNCTION_EXISTS</code><a class="headerlink" href="#command:check_fortran_function_exists" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">CHECK_FORTRAN_FUNCTION_EXISTS(</span><span class="nv">&lt;function&gt;</span><span class="w"> </span><span class="nv">&lt;result&gt;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
<p>where</p>
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">&lt;function&gt;</span></code></dt><dd><p>the name of the Fortran function</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">&lt;result&gt;</span></code></dt><dd><p>variable to store the result; will be created as an internal cache variable.</p>
</dd>
</dl>
</dd></dl>
...
<p><span class="versionmodified added">New in version 3.14: </span>A <a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">;-list</span></a> of options to add to the link
