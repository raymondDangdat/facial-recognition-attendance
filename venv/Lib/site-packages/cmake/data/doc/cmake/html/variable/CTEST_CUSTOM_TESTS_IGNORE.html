...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_CUSTOM_TESTS_IGNORE &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="ctest-custom-tests-ignore">
<span id="variable:CTEST_CUSTOM_TESTS_IGNORE"></span><h1>CTEST_CUSTOM_TESTS_IGNORE<a class="headerlink" href="#ctest-custom-tests-ignore" title="Permalink to this headline">¶</a></h1>
<p>A list of regular expressions to use to exclude tests during the
<span class="target" id="index-0-command:ctest_test"></span><a class="reference internal" href="../command/ctest_test.html#command:ctest_test" title="ctest_test"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_test()</span></code></a> command.</p>
...
file. See <span class="target" id="index-0-command:ctest_read_custom_files"></span><a class="reference internal" href="../command/ctest_read_custom_files.html#command:ctest_read_custom_files" title="ctest_read_custom_files"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_read_custom_files()</span></code></a> documentation.</p>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CTEST_CUSTOM_TESTS_IGNORE.rst.txt"
