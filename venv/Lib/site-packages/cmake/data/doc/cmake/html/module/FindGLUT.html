...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindGLUT &mdash; CMake 3.21.0 Documentation</title>
...
<p>Find OpenGL Utility Toolkit (GLUT) library and include files.</p>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">GLUT::GLUT</span></code></dt><dd><p>Defined if the system has GLUT.</p>
</dd>
</dl>
</div>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>GLUT_INCLUDE_DIR, where to find GL/glut.h, etc.
GLUT_LIBRARIES, the libraries to link against
GLUT_FOUND, If false, do not try to use GLUT.
</pre></div>
</div>
<p>Also defined, but not for general use are:</p>
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>GLUT_glut_LIBRARY = the full path to the glut library.
