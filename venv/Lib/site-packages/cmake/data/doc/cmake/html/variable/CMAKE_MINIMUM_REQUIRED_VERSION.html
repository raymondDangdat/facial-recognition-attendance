...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_MINIMUM_REQUIRED_VERSION &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_MATCH_&lt;n&gt;" href="CMAKE_MATCH_n.html" />
...
<p>The <code class="docutils literal notranslate"><span class="pre">&lt;min&gt;</span></code> version of CMake given to the most recent call to the
<span class="target" id="index-0-command:cmake_minimum_required"></span><a class="reference internal" href="../command/cmake_minimum_required.html#command:cmake_minimum_required" title="cmake_minimum_required"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cmake_minimum_required(VERSION)</span></code></a> command in the current
variable scope or any parent variable scope.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_MATCH_n.html"
                        title="previous chapter">CMAKE_MATCH_&lt;n&gt;</a></p>
  <h4>Next topic</h4>
