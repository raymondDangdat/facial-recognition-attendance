...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>IMPORTED_TARGETS &mdash; CMake 3.21.0 Documentation</title>
...
<span id="prop_dir:IMPORTED_TARGETS"></span><h1>IMPORTED_TARGETS<a class="headerlink" href="#imported-targets" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.21.</span></p>
</div>
<p>This read-only directory property contains a
<a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a> of
<a class="reference internal" href="../manual/cmake-buildsystem.7.html#imported-targets"><span class="std std-ref">Imported Targets</span></a> added in the directory by calls to the
...
to pass to the <span class="target" id="index-0-command:get_property"></span><a class="reference internal" href="../command/get_property.html#command:get_property" title="get_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">get_property()</span></code></a> command <code class="docutils literal notranslate"><span class="pre">TARGET</span></code> option
when called in the same directory.</p>
<p>See also the <span class="target" id="index-0-prop_dir:BUILDSYSTEM_TARGETS"></span><a class="reference internal" href="BUILDSYSTEM_TARGETS.html#prop_dir:BUILDSYSTEM_TARGETS" title="BUILDSYSTEM_TARGETS"><code class="xref cmake cmake-prop_dir docutils literal notranslate"><span class="pre">BUILDSYSTEM_TARGETS</span></code></a> directory property.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/prop_dir/IMPORTED_TARGETS.rst.txt"
