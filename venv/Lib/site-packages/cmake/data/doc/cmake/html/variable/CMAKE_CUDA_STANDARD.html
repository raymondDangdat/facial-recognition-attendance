...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_CUDA_STANDARD &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_CUDA_HOST_COMPILER" href="CMAKE_CUDA_HOST_COMPILER.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_CUDA_HOST_COMPILER.html" title="CMAKE_CUDA_HOST_COMPILER"
...
<p>Default value for <span class="target" id="index-0-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="../prop_tgt/CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_STANDARD</span></code></a> property of targets.</p>
<p>This variable is used to initialize the <span class="target" id="index-1-prop_tgt:CUDA_STANDARD"></span><a class="reference internal" href="../prop_tgt/CUDA_STANDARD.html#prop_tgt:CUDA_STANDARD" title="CUDA_STANDARD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CUDA_STANDARD</span></code></a>
...
compile features and a list of supported compilers.</p>
  ...
  <p class="topless"><a href="CMAKE_CUDA_HOST_COMPILER.html"
                        title="previous chapter">CMAKE_CUDA_HOST_COMPILER</a></p>
  <h4>Next topic</h4>
