...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  ...
  <title>CMAKE_TOOLCHAIN_FILE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_Swift_NUM_THREADS" href="CMAKE_Swift_NUM_THREADS.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_Swift_NUM_THREADS.html" title="CMAKE_Swift_NUM_THREADS"
...
<p>Path to toolchain file supplied to <span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a>.</p>
...
<p>Relative paths are allowed and are interpreted first as relative to the
build directory, and if not found, relative to the source directory.</p>
<p>This is initialized by the <span class="target" id="index-0-envvar:CMAKE_TOOLCHAIN_FILE"></span><a class="reference internal" href="../envvar/CMAKE_TOOLCHAIN_FILE.html#envvar:CMAKE_TOOLCHAIN_FILE" title="CMAKE_TOOLCHAIN_FILE"><code class="xref cmake cmake-envvar docutils literal notranslate"><span class="pre">CMAKE_TOOLCHAIN_FILE</span></code></a> environment
variable if it is set when a new build tree is first created.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_Swift_NUM_THREADS.html"
                        title="previous chapter">CMAKE_Swift_NUM_THREADS</a></p>
  <h4>Next topic</h4>
