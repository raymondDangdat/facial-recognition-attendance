...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0091 &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMP0090" href="CMP0090.html" />
    <link rel="prev" title="CMP0092" href="CMP0092.html" />
  ...
  <div class="section" id="cmp0091">
<span id="policy:CMP0091"></span><h1>CMP0091<a class="headerlink" href="#cmp0091" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.15.</span></p>
</div>
<p>MSVC runtime library flags are selected by an abstraction.</p>
<p>Compilers targeting the MSVC ABI have flags to select the MSVC runtime library.
Runtime library selection typically varies with build configuration because
there is a separate runtime library for Debug builds.</p>
<p>In CMake 3.14 and below, MSVC runtime library selection flags are added to
...
<p>CMake 3.15 and above prefer to leave the MSVC runtime library selection flags
out of the default <span class="target" id="index-2-variable:CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;"></span><a class="reference internal" href="../variable/CMAKE_LANG_FLAGS_CONFIG.html#variable:CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;" title="CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;</span></code></a> values and instead
offer a first-class abstraction.  The <span class="target" id="index-0-variable:CMAKE_MSVC_RUNTIME_LIBRARY"></span><a class="reference internal" href="../variable/CMAKE_MSVC_RUNTIME_LIBRARY.html#variable:CMAKE_MSVC_RUNTIME_LIBRARY" title="CMAKE_MSVC_RUNTIME_LIBRARY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_MSVC_RUNTIME_LIBRARY</span></code></a>
variable and <span class="target" id="index-0-prop_tgt:MSVC_RUNTIME_LIBRARY"></span><a class="reference internal" href="../prop_tgt/MSVC_RUNTIME_LIBRARY.html#prop_tgt:MSVC_RUNTIME_LIBRARY" title="MSVC_RUNTIME_LIBRARY"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">MSVC_RUNTIME_LIBRARY</span></code></a> target property may be set to
select the MSVC runtime library.  If they are not set then CMake uses the
default value <code class="docutils literal notranslate"><span class="pre">MultiThreaded$&lt;$&lt;CONFIG:Debug&gt;:Debug&gt;DLL</span></code> which is
equivalent to the original flags.</p>
...
<p>The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy is to place MSVC runtime library
flags in the default <span class="target" id="index-3-variable:CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;"></span><a class="reference internal" href="../variable/CMAKE_LANG_FLAGS_CONFIG.html#variable:CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;" title="CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_&lt;LANG&gt;_FLAGS_&lt;CONFIG&gt;</span></code></a> cache
entries and ignore the <span class="target" id="index-1-variable:CMAKE_MSVC_RUNTIME_LIBRARY"></span><a class="reference internal" href="../variable/CMAKE_MSVC_RUNTIME_LIBRARY.html#variable:CMAKE_MSVC_RUNTIME_LIBRARY" title="CMAKE_MSVC_RUNTIME_LIBRARY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_MSVC_RUNTIME_LIBRARY</span></code></a> abstraction.
The <code class="docutils literal notranslate"><span class="pre">NEW</span></code> behavior for this policy is to <em>not</em> place MSVC runtime
...
and may be removed in a future version of CMake.</p>
  ...
  <p class="topless"><a href="CMP0092.html"
                        title="previous chapter">CMP0092</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="CMP0090.html"
                        title="next chapter">CMP0090</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/policy/CMP0091.rst.txt"
