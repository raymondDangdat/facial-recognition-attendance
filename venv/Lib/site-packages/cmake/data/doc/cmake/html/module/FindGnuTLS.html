...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindGnuTLS &mdash; CMake 3.21.0 Documentation</title>
...
<p>Find the GNU Transport Layer Security library (gnutls)</p>
...
<p>This module defines <span class="target" id="index-0-prop_tgt:IMPORTED"></span><a class="reference internal" href="../prop_tgt/IMPORTED.html#prop_tgt:IMPORTED" title="IMPORTED"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">IMPORTED</span></code></a> target <code class="docutils literal notranslate"><span class="pre">GnuTLS::GnuTLS</span></code>, if
gnutls has been found.</p>
</div>
...
<dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_FOUND</span></code></dt><dd><p>System has gnutls</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_INCLUDE_DIR</span></code></dt><dd><p>The gnutls include directory</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_LIBRARIES</span></code></dt><dd><p>The libraries needed to use gnutls</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_DEFINITIONS</span></code></dt><dd><p>Compiler switches required for using gnutls</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">GNUTLS_VERSION</span></code></dt><dd><p>version of gnutls.</p>
</dd>
</dl>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#">FindGnuTLS</a><ul>
