...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_EDIT_COMMAND &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_DOTNET_TARGET_FRAMEWORK_VERSION" href="CMAKE_DOTNET_TARGET_FRAMEWORK_VERSION.html" />
...
edit the cache.  For example, <span class="target" id="index-1-manual:cmake-gui(1)"></span><a class="reference internal" href="../manual/cmake-gui.1.html#manual:cmake-gui(1)" title="cmake-gui(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake-gui(1)</span></code></a> or <span class="target" id="index-1-manual:ccmake(1)"></span><a class="reference internal" href="../manual/ccmake.1.html#manual:ccmake(1)" title="ccmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ccmake(1)</span></code></a>.</p>
  ...
  <p class="topless"><a href="CMAKE_DOTNET_TARGET_FRAMEWORK_VERSION.html"
                        title="previous chapter">CMAKE_DOTNET_TARGET_FRAMEWORK_VERSION</a></p>
  <h4>Next topic</h4>
