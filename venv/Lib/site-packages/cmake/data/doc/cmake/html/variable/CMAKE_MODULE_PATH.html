...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_MODULE_PATH &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_MESSAGE_LOG_LEVEL" href="CMAKE_MESSAGE_LOG_LEVEL.html" />
...
for CMake modules to be loaded by the <span class="target" id="index-0-command:include"></span><a class="reference internal" href="../command/include.html#command:include" title="include"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">include()</span></code></a> or
<span class="target" id="index-0-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> commands before checking the default modules that come
with CMake.  By default it is empty, it is intended to be set by the project.</p>
  ...
  <p class="topless"><a href="CMAKE_MESSAGE_LOG_LEVEL.html"
                        title="previous chapter">CMAKE_MESSAGE_LOG_LEVEL</a></p>
  <h4>Next topic</h4>
