...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_ECLIPSE_RESOURCE_ENCODING &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmake-eclipse-resource-encoding">
<span id="variable:CMAKE_ECLIPSE_RESOURCE_ENCODING"></span><h1>CMAKE_ECLIPSE_RESOURCE_ENCODING<a class="headerlink" href="#cmake-eclipse-resource-encoding" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16.</span></p>
</div>
<p>This cache variable tells the <span class="target" id="index-0-generator:Eclipse CDT4"></span><a class="reference internal" href="../generator/Eclipse CDT4.html#generator:Eclipse CDT4" title="Eclipse CDT4"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Eclipse</span> <span class="pre">CDT4</span></code></a> project generator
to set the resource encoding to the given value in generated project files.
If no value is given, no encoding will be set.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_ECLIPSE_RESOURCE_ENCODING.rst.txt"
