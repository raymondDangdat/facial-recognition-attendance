...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>LDFLAGS &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="MACOSX_DEPLOYMENT_TARGET" href="MACOSX_DEPLOYMENT_TARGET.html" />
    <link rel="prev" title="DESTDIR" href="DESTDIR.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="DESTDIR.html" title="DESTDIR"
  ...
  <div class="section" id="ldflags">
<span id="envvar:LDFLAGS"></span><h1>LDFLAGS<a class="headerlink" href="#ldflags" title="Permalink to this headline">¶</a></h1>
...
<p>Will only be used by CMake on the first configuration to determine the default
linker flags, after which the value for <code class="docutils literal notranslate"><span class="pre">LDFLAGS</span></code> is stored in the cache
as <span class="target" id="index-0-variable:CMAKE_EXE_LINKER_FLAGS_INIT"></span><a class="reference internal" href="../variable/CMAKE_EXE_LINKER_FLAGS_INIT.html#variable:CMAKE_EXE_LINKER_FLAGS_INIT" title="CMAKE_EXE_LINKER_FLAGS_INIT"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_EXE_LINKER_FLAGS_INIT</span></code></a>,
...
equivalent  <code class="docutils literal notranslate"><span class="pre">CMAKE_&lt;TYPE&gt;_LINKER_FLAGS_INIT</span></code> variable is defined.</p>
  ...
  <p class="topless"><a href="DESTDIR.html"
                        title="previous chapter">DESTDIR</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="MACOSX_DEPLOYMENT_TARGET.html"
                        title="next chapter">MACOSX_DEPLOYMENT_TARGET</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/envvar/LDFLAGS.rst.txt"
