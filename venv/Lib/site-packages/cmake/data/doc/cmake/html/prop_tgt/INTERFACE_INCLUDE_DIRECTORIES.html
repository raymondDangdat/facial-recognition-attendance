...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_INCLUDE_DIRECTORIES &mdash; CMake 3.21.0 Documentation</title>
...
required to compile against the headers for the target.  The <span class="target" id="index-0-command:target_include_directories"></span><a class="reference internal" href="../command/target_include_directories.html#command:target_include_directories" title="target_include_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_include_directories()</span></code></a>
...
<code class="docutils literal notranslate"><span class="pre">INTERFACE_INCLUDE_DIRECTORIES</span></code> of a target with absolute paths to the include
...
<p>The <code class="docutils literal notranslate"><span class="pre">INSTALL_INTERFACE</span></code> of the <code class="docutils literal notranslate"><span class="pre">INTERFACE_INCLUDE_DIRECTORIES</span></code> is only
