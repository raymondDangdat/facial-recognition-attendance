...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>ExternalProject &mdash; CMake 3.21.0 Documentation</title>
...
<code class="docutils literal notranslate"><span class="pre">CMAKE_TLS_CAINFO</span></code> variable will be used instead (see
...
If this option is not specified, the value of the <code class="docutils literal notranslate"><span class="pre">CMAKE_NETRC</span></code>
...
be used instead (see <span class="target" id="index-5-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(DOWNLOAD)</span></code></a>)</p>
</dd>
</dl>
