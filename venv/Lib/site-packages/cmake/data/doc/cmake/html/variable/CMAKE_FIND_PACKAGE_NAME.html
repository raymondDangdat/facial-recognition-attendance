...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_FIND_PACKAGE_NAME &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_FIND_DEBUG_MODE" href="CMAKE_FIND_DEBUG_MODE.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_FIND_DEBUG_MODE.html" title="CMAKE_FIND_DEBUG_MODE"
...
<p><span class="versionmodified added">New in version 3.1.1.</span></p>
</div>
<p>Defined by the <span class="target" id="index-0-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> command while loading
...
See command documentation for details.</p>
  ...
  <p class="topless"><a href="CMAKE_FIND_DEBUG_MODE.html"
                        title="previous chapter">CMAKE_FIND_DEBUG_MODE</a></p>
  <h4>Next topic</h4>
