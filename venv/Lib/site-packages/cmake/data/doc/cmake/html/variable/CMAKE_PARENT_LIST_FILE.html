...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_PARENT_LIST_FILE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_NETRC_FILE" href="CMAKE_NETRC_FILE.html" />
...
<p>While processing a CMake file loaded by <span class="target" id="index-0-command:include"></span><a class="reference internal" href="../command/include.html#command:include" title="include"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">include()</span></code></a> or
<span class="target" id="index-0-command:find_package"></span><a class="reference internal" href="../command/find_package.html#command:find_package" title="find_package"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">find_package()</span></code></a> this variable contains the full path to the file
including it.  The top of the include stack is always the <code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code>
for the current directory.  See also <span class="target" id="index-0-variable:CMAKE_CURRENT_LIST_FILE"></span><a class="reference internal" href="CMAKE_CURRENT_LIST_FILE.html#variable:CMAKE_CURRENT_LIST_FILE" title="CMAKE_CURRENT_LIST_FILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CURRENT_LIST_FILE</span></code></a>.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_NETRC_FILE.html"
                        title="previous chapter">CMAKE_NETRC_FILE</a></p>
  <h4>Next topic</h4>
