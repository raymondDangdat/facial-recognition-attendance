...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>PREFIX &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="PRECOMPILE_HEADERS_REUSE_FROM" href="PRECOMPILE_HEADERS_REUSE_FROM.html" />
...
<code class="docutils literal notranslate"><span class="pre">lib</span></code>) on a library name.</p>
</div>
  ...
  <p class="topless"><a href="PRECOMPILE_HEADERS_REUSE_FROM.html"
                        title="previous chapter">PRECOMPILE_HEADERS_REUSE_FROM</a></p>
  <h4>Next topic</h4>
