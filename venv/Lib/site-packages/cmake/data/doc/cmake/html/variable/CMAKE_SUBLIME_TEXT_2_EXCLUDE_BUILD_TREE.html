...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_SUBLIME_TEXT_2_EXCLUDE_BUILD_TREE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_SUPPRESS_REGENERATION" href="CMAKE_SUPPRESS_REGENERATION.html" />
...
<code class="docutils literal notranslate"><span class="pre">CMakeLists.txt</span></code> file, the <span class="target" id="index-0-generator:Sublime Text 2"></span><a class="reference internal" href="../generator/Sublime Text 2.html#generator:Sublime Text 2" title="Sublime Text 2"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Sublime</span> <span class="pre">Text</span> <span class="pre">2</span></code></a> extra generator
excludes the build tree from the <code class="docutils literal notranslate"><span class="pre">.sublime-project</span></code> if it is inside the
source tree.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_SUPPRESS_REGENERATION.html"
                        title="next chapter">CMAKE_SUPPRESS_REGENERATION</a></p>
