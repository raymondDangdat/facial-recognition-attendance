...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_MSVC_RUNTIME_LIBRARY &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cmake-msvc-runtime-library">
<span id="variable:CMAKE_MSVC_RUNTIME_LIBRARY"></span><h1>CMAKE_MSVC_RUNTIME_LIBRARY<a class="headerlink" href="#cmake-msvc-runtime-library" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.15.</span></p>
</div>
<p>Select the MSVC runtime library for use by compilers targeting the MSVC ABI.
This variable is used to initialize the <span class="target" id="index-0-prop_tgt:MSVC_RUNTIME_LIBRARY"></span><a class="reference internal" href="../prop_tgt/MSVC_RUNTIME_LIBRARY.html#prop_tgt:MSVC_RUNTIME_LIBRARY" title="MSVC_RUNTIME_LIBRARY"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">MSVC_RUNTIME_LIBRARY</span></code></a>
...
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set(</span><span class="no">CMAKE_MSVC_RUNTIME_LIBRARY</span><span class="w"> </span><span class="s">&quot;MultiThreaded$&lt;$&lt;CONFIG:Debug&gt;:Debug&gt;&quot;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
<p>If this variable is not set then the <span class="target" id="index-1-prop_tgt:MSVC_RUNTIME_LIBRARY"></span><a class="reference internal" href="../prop_tgt/MSVC_RUNTIME_LIBRARY.html#prop_tgt:MSVC_RUNTIME_LIBRARY" title="MSVC_RUNTIME_LIBRARY"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">MSVC_RUNTIME_LIBRARY</span></code></a> target
property will not be set automatically.  If that property is not set then
CMake uses the default value <code class="docutils literal notranslate"><span class="pre">MultiThreaded$&lt;$&lt;CONFIG:Debug&gt;:Debug&gt;DLL</span></code>
to select a MSVC runtime library.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This variable has effect only when policy <span class="target" id="index-0-policy:CMP0091"></span><a class="reference internal" href="../policy/CMP0091.html#policy:CMP0091" title="CMP0091"><code class="xref cmake cmake-policy docutils literal notranslate"><span class="pre">CMP0091</span></code></a> is set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>
...
that enables a language using a compiler targeting the MSVC ABI.</p>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_MSVC_RUNTIME_LIBRARY.rst.txt"
