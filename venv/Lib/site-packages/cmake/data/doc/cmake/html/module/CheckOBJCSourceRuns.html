...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckOBJCSourceRuns &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CheckOBJCXXCompilerFlag" href="CheckOBJCXXCompilerFlag.html" />
    <link rel="prev" title="CheckOBJCSourceCompiles" href="CheckOBJCSourceCompiles.html" />
  ...
  <div class="section" id="checkobjcsourceruns">
<span id="module:CheckOBJCSourceRuns"></span><h1>CheckOBJCSourceRuns<a class="headerlink" href="#checkobjcsourceruns" title="Permalink to this headline">¶</a></h1>
...
<dl class="command">
<dt id="command:check_objc_source_runs">
<code class="sig-name descname">check_objc_source_runs</code><a class="headerlink" href="#command:check_objc_source_runs" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_objc_source_runs(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_objc_source_runs()</span></code>:</p>
<dl class="simple">
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckOBJCSourceCompiles.html"
                        title="previous chapter">CheckOBJCSourceCompiles</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="CheckOBJCXXCompilerFlag.html"
                        title="next chapter">CheckOBJCXXCompilerFlag</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CheckOBJCSourceRuns.rst.txt"
