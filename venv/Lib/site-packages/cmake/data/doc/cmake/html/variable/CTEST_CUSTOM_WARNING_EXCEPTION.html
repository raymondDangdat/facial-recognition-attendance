...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CTEST_CUSTOM_WARNING_EXCEPTION &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CTEST_CUSTOM_TESTS_IGNORE" href="CTEST_CUSTOM_TESTS_IGNORE.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CTEST_CUSTOM_TESTS_IGNORE.html" title="CTEST_CUSTOM_TESTS_IGNORE"
...
warning messages in build outputs by the <span class="target" id="index-0-command:ctest_build"></span><a class="reference internal" href="../command/ctest_build.html#command:ctest_build" title="ctest_build"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_build()</span></code></a> command.</p>
<p>It is initialized by <span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a>, but may be edited in a <code class="docutils literal notranslate"><span class="pre">CTestCustom</span></code>
file. See <span class="target" id="index-0-command:ctest_read_custom_files"></span><a class="reference internal" href="../command/ctest_read_custom_files.html#command:ctest_read_custom_files" title="ctest_read_custom_files"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">ctest_read_custom_files()</span></code></a> documentation.</p>
</div>
  ...
  <p class="topless"><a href="CTEST_CUSTOM_TESTS_IGNORE.html"
                        title="previous chapter">CTEST_CUSTOM_TESTS_IGNORE</a></p>
  <h4>Next topic</h4>
