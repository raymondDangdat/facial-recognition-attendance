...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CXX_STANDARD &mdash; CMake 3.21.0 Documentation</title>
...
flag such as <code class="docutils literal notranslate"><span class="pre">-std=gnu++11</span></code> to the compile line.  For compilers that
have no notion of a standard level, such as Microsoft Visual C++ before
2015 Update 3, this has no effect.</p>
<p>Supported values are:</p>
<dl>
<dt><code class="docutils literal notranslate"><span class="pre">98</span></code></dt><dd><p>C++98</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">11</span></code></dt><dd><p>C++11</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">14</span></code></dt><dd><p>C++14</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">17</span></code></dt><dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.8.</span></p>
</div>
<p>C++17</p>
</dd>
<dt><code class="docutils literal notranslate"><span class="pre">20</span></code></dt><dd><div class="versionadded">
...
with the <span class="target" id="index-0-prop_tgt:CXX_STANDARD_REQUIRED"></span><a class="reference internal" href="CXX_STANDARD_REQUIRED.html#prop_tgt:CXX_STANDARD_REQUIRED" title="CXX_STANDARD_REQUIRED"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CXX_STANDARD_REQUIRED</span></code></a> target property.
Additionally, the <span class="target" id="index-0-prop_tgt:CXX_EXTENSIONS"></span><a class="reference internal" href="CXX_EXTENSIONS.html#prop_tgt:CXX_EXTENSIONS" title="CXX_EXTENSIONS"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">CXX_EXTENSIONS</span></code></a> target property may be used to
