...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>cmake-presets(7) &mdash; CMake 3.21.0 Documentation</title>
...
<ul>
<li><p><a class="reference internal" href="#configure-preset" id="id4">Configure Preset</a></p></li>
<li><p><a class="reference internal" href="#build-preset" id="id5">Build Preset</a></p></li>
<li><p><a class="reference internal" href="#test-preset" id="id6">Test Preset</a></p></li>
<li><p><a class="reference internal" href="#condition" id="id7">Condition</a></p></li>
<li><p><a class="reference internal" href="#macro-expansion" id="id8">Macro Expansion</a></p></li>
</ul>
</li>
...
<div class="highlight-json notranslate"><div class="highlight"><pre><span></span><span class="p">{</span>
  ...
  <span class="nt">&quot;cmakeMinimumRequired&quot;</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="nt">&quot;minor&quot;</span><span class="p">:</span> <span class="mi">21</span><span class="p">,</span>
...
The supported versions are <code class="docutils literal notranslate"><span class="pre">1</span></code>, <code class="docutils literal notranslate"><span class="pre">2</span></code>, and <code class="docutils literal notranslate"><span class="pre">3</span></code>.</p>
</div></blockquote>
...
<h3><a class="toc-backref" href="#id4">Configure Preset</a><a class="headerlink" href="#configure-preset" title="Permalink to this headline">¶</a></h3>
...
relative to the source directory. Takes precedence over any <cite>CMAKE_TOOLCHAIN_FILE</cite>
value. This is allowed in preset files specifying version <code class="docutils literal notranslate"><span class="pre">3</span></code> or above.</p>
</div></blockquote>
...
<h3><a class="toc-backref" href="#id5">Build Preset</a><a class="headerlink" href="#build-preset" title="Permalink to this headline">¶</a></h3>
...
<p><code class="docutils literal notranslate"><span class="pre">inherits</span></code></p>
<blockquote>
<div><p>An optional array of strings representing the names of presets to
...
will be preferred. Presets in <code class="docutils literal notranslate"><span class="pre">CMakePresets.json</span></code> may not inherit from
presets in <code class="docutils literal notranslate"><span class="pre">CMakeUserPresets.json</span></code>.</p>
<p>This field can also be a string, which is equivalent to an array
containing one string.</p>
</div></blockquote>
<p><code class="docutils literal notranslate"><span class="pre">condition</span></code></p>
...
<h3><a class="toc-backref" href="#id6">Test Preset</a><a class="headerlink" href="#test-preset" title="Permalink to this headline">¶</a></h3>
...
<h3><a class="toc-backref" href="#id7">Condition</a><a class="headerlink" href="#condition" title="Permalink to this headline">¶</a></h3>
...
<h3><a class="toc-backref" href="#id8">Macro Expansion</a><a class="headerlink" href="#macro-expansion" title="Permalink to this headline">¶</a></h3>
