...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INTERFACE_SOURCES &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="INTERFACE_PRECOMPILE_HEADERS" href="INTERFACE_PRECOMPILE_HEADERS.html" />
...
for consuming targets to compile.  The <span class="target" id="index-0-command:target_sources"></span><a class="reference internal" href="../command/target_sources.html#command:target_sources" title="target_sources"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">target_sources()</span></code></a> command
...
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INTERFACE_SOURCES</span></code> may use &quot;generator expressions&quot;
...
manual for more on defining buildsystem properties.</p>
  ...
  <p class="topless"><a href="INTERFACE_PRECOMPILE_HEADERS.html"
                        title="previous chapter">INTERFACE_PRECOMPILE_HEADERS</a></p>
  <h4>Next topic</h4>
