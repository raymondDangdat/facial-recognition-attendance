...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>VS_GLOBAL_KEYWORD &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="VS_DPI_AWARE" href="VS_DPI_AWARE.html" />
...
project.</p>
<p>Use the <span class="target" id="index-0-prop_tgt:VS_KEYWORD"></span><a class="reference internal" href="VS_KEYWORD.html#prop_tgt:VS_KEYWORD" title="VS_KEYWORD"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">VS_KEYWORD</span></code></a> target property to set the
keyword for Visual Studio 9 (2008) and older.</p>
  ...
  <p class="topless"><a href="VS_DPI_AWARE.html"
                        title="previous chapter">VS_DPI_AWARE</a></p>
  <h4>Next topic</h4>
