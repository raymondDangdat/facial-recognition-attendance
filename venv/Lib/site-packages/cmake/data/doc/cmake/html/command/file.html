...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>file &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="variable">
<dt id="variable:CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM">
<code class="sig-name descname">CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_PLATFORM" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL">
<code class="sig-name descname">CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_TOOL" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND">
<code class="sig-name descname">CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND</code><a class="headerlink" href="#variable:CMAKE_GET_RUNTIME_DEPENDENCIES_COMMAND" title="Permalink to this definition">¶</a></dt>
...
<dt><code class="docutils literal notranslate"><span class="pre">ONLY_IF_DIFFERENT</span></code></dt><dd><p>If the <code class="docutils literal notranslate"><span class="pre">&lt;newname&gt;</span></code> path already exists, do not replace it if it is the
same as <code class="docutils literal notranslate"><span class="pre">&lt;oldname&gt;</span></code>. Otherwise, an error is emitted.</p>
</dd>
</dl>
...
Installation scripts generated by the <span class="target" id="index-4-command:install"></span><a class="reference internal" href="install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install()</span></code></a> command
...
The default is to <em>not</em> verify.</p>
<div class="versionadded">
...
<dt><code class="docutils literal notranslate"><span class="pre">TLS_CAINFO</span> <span class="pre">&lt;file&gt;</span></code></dt><dd><p>Specify a custom Certificate Authority file for <code class="docutils literal notranslate"><span class="pre">https://</span></code> URLs.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.18: </span>Added support to <code class="docutils literal notranslate"><span class="pre">file(UPLOAD)</span></code>.</p>
</div>
</dd>
...
check certificates. If neither <code class="docutils literal notranslate"><span class="pre">TLS</span></code> option is given CMake will check
variables <span class="target" id="index-0-variable:CMAKE_TLS_VERIFY"></span><a class="reference internal" href="../variable/CMAKE_TLS_VERIFY.html#variable:CMAKE_TLS_VERIFY" title="CMAKE_TLS_VERIFY"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_TLS_VERIFY</span></code></a> and <code class="docutils literal notranslate"><span class="pre">CMAKE_TLS_CAINFO</span></code>, respectively.</p>
