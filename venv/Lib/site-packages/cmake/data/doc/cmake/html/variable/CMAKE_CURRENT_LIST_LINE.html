...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_CURRENT_LIST_LINE &mdash; CMake 3.21.0 Documentation</title>
...
cmake.</p>
<p>If CMake is currently processing deferred calls scheduled by
the <span class="target" id="index-0-command:cmake_language"></span><a class="reference internal" href="../command/cmake_language.html#command:cmake_language" title="cmake_language"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">cmake_language(DEFER)</span></code></a> command, this variable
evaluates to <code class="docutils literal notranslate"><span class="pre">DEFERRED</span></code> instead of a specific line number.</p>
</div>
