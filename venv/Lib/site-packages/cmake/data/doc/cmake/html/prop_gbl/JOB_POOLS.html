...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>JOB_POOLS &mdash; CMake 3.21.0 Documentation</title>
...
The <span class="target" id="index-0-prop_gbl:JOB_POOLS"></span><a class="reference internal" href="#prop_gbl:JOB_POOLS" title="JOB_POOLS"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">JOB_POOLS</span></code></a> property is a semicolon-separated list of
pairs using the syntax NAME=integer (without a space after the equality sign).</p>
<p>For instance:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">set_property(</span><span class="no">GLOBAL</span><span class="w"> </span><span class="no">PROPERTY</span><span class="w"> </span><span class="no">JOB_POOLS</span><span class="w"> </span><span class="nb">two_jobs</span><span class="p">=</span><span class="m">2</span><span class="w"> </span><span class="nb">ten_jobs</span><span class="p">=</span><span class="m">10</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
<p>Defined pools could be used globally by setting
<span class="target" id="index-0-variable:CMAKE_JOB_POOL_COMPILE"></span><a class="reference internal" href="../variable/CMAKE_JOB_POOL_COMPILE.html#variable:CMAKE_JOB_POOL_COMPILE" title="CMAKE_JOB_POOL_COMPILE"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_JOB_POOL_COMPILE</span></code></a> and <span class="target" id="index-0-variable:CMAKE_JOB_POOL_LINK"></span><a class="reference internal" href="../variable/CMAKE_JOB_POOL_LINK.html#variable:CMAKE_JOB_POOL_LINK" title="CMAKE_JOB_POOL_LINK"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_JOB_POOL_LINK</span></code></a>
or per target by setting the target properties
<span class="target" id="index-0-prop_tgt:JOB_POOL_COMPILE"></span><a class="reference internal" href="../prop_tgt/JOB_POOL_COMPILE.html#prop_tgt:JOB_POOL_COMPILE" title="JOB_POOL_COMPILE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">JOB_POOL_COMPILE</span></code></a> and <span class="target" id="index-0-prop_tgt:JOB_POOL_LINK"></span><a class="reference internal" href="../prop_tgt/JOB_POOL_LINK.html#prop_tgt:JOB_POOL_LINK" title="JOB_POOL_LINK"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">JOB_POOL_LINK</span></code></a>.
<span class="target" id="index-0-command:add_custom_command"></span><a class="reference internal" href="../command/add_custom_command.html#command:add_custom_command" title="add_custom_command"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">Custom</span> <span class="pre">commands</span></code></a> and
<span class="target" id="index-0-command:add_custom_target"></span><a class="reference internal" href="../command/add_custom_target.html#command:add_custom_target" title="add_custom_target"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">custom</span> <span class="pre">targets</span></code></a> can specify pools using the
option <code class="docutils literal notranslate"><span class="pre">JOB_POOL</span></code>.
Using a pool that is not defined by <span class="target" id="index-1-prop_gbl:JOB_POOLS"></span><a class="reference internal" href="#prop_gbl:JOB_POOLS" title="JOB_POOLS"><code class="xref cmake cmake-prop_gbl docutils literal notranslate"><span class="pre">JOB_POOLS</span></code></a> causes
an error by ninja at build time.</p>
<p>If not set, this property uses the value of the <span class="target" id="index-0-variable:CMAKE_JOB_POOLS"></span><a class="reference internal" href="../variable/CMAKE_JOB_POOLS.html#variable:CMAKE_JOB_POOLS" title="CMAKE_JOB_POOLS"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_JOB_POOLS</span></code></a>
variable.</p>
<p>Build targets provided by CMake that are meant for individual interactive
use, such as <code class="docutils literal notranslate"><span class="pre">install</span></code>, are placed in the <code class="docutils literal notranslate"><span class="pre">console</span></code> pool automatically.</p>
</div>
