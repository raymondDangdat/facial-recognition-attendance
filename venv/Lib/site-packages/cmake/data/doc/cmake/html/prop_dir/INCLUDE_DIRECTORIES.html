...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INCLUDE_DIRECTORIES &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="IMPORTED_TARGETS" href="IMPORTED_TARGETS.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="IMPORTED_TARGETS.html" title="IMPORTED_TARGETS"
...
<span class="target" id="index-0-command:include_directories"></span><a class="reference internal" href="../command/include_directories.html#command:include_directories" title="include_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">include_directories()</span></code></a> command.</p>
...
directly on any directory using the <span class="target" id="index-0-command:set_property"></span><a class="reference internal" href="../command/set_property.html#command:set_property" title="set_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_property()</span></code></a> command, and can be
set on the current directory using the <span class="target" id="index-0-command:set_directory_properties"></span><a class="reference internal" href="../command/set_directory_properties.html#command:set_directory_properties" title="set_directory_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_directory_properties()</span></code></a>
command.  A directory gets its initial value from its parent directory if it has
one.  The initial value of the <span class="target" id="index-1-prop_tgt:INCLUDE_DIRECTORIES"></span><a class="reference internal" href="../prop_tgt/INCLUDE_DIRECTORIES.html#prop_tgt:INCLUDE_DIRECTORIES" title="INCLUDE_DIRECTORIES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code></a> target property
comes from the value of this property.  Both directory and target property
values are adjusted by calls to the <span class="target" id="index-1-command:include_directories"></span><a class="reference internal" href="../command/include_directories.html#command:include_directories" title="include_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">include_directories()</span></code></a> command.
Calls to <span class="target" id="index-1-command:set_property"></span><a class="reference internal" href="../command/set_property.html#command:set_property" title="set_property"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_property()</span></code></a> or <span class="target" id="index-1-command:set_directory_properties"></span><a class="reference internal" href="../command/set_directory_properties.html#command:set_directory_properties" title="set_directory_properties"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set_directory_properties()</span></code></a>,
...
calls to <span class="target" id="index-0-command:add_executable"></span><a class="reference internal" href="../command/add_executable.html#command:add_executable" title="add_executable"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_executable()</span></code></a> or <span class="target" id="index-0-command:add_library"></span><a class="reference internal" href="../command/add_library.html#command:add_library" title="add_library"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">add_library()</span></code></a> for targets
they are meant to affect.</p>
<p>The target property values are used by the generators to set the
include paths for the compiler.</p>
<p>Contents of <code class="docutils literal notranslate"><span class="pre">INCLUDE_DIRECTORIES</span></code> may use &quot;generator expressions&quot; with
...
manual for more on defining buildsystem properties.</p>
  ...
  <p class="topless"><a href="IMPORTED_TARGETS.html"
                        title="previous chapter">IMPORTED_TARGETS</a></p>
  <h4>Next topic</h4>
