...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>install_targets &mdash; CMake 3.21.0 Documentation</title>
...
<div class="highlight-none notranslate"><div class="highlight"><pre><span></span>install_targets(&lt;dir&gt; [RUNTIME_DIRECTORY dir] target target)
</pre></div>
</div>
<p>Create rules to install the listed targets into the given directory.
The directory <code class="docutils literal notranslate"><span class="pre">&lt;dir&gt;</span></code> is relative to the installation prefix, which is
stored in the variable <span class="target" id="index-0-variable:CMAKE_INSTALL_PREFIX"></span><a class="reference internal" href="../variable/CMAKE_INSTALL_PREFIX.html#variable:CMAKE_INSTALL_PREFIX" title="CMAKE_INSTALL_PREFIX"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_INSTALL_PREFIX</span></code></a>.  If
<code class="docutils literal notranslate"><span class="pre">RUNTIME_DIRECTORY</span></code> is specified, then on systems with special runtime
