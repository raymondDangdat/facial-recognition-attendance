...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack Cygwin Generator &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpack-cygwin-generator">
<span id="cpack_gen:CPack Cygwin Generator"></span><h1>CPack Cygwin Generator<a class="headerlink" href="#cpack-cygwin-generator" title="Permalink to this headline">¶</a></h1>
<p>Cygwin CPack generator (Cygwin).</p>
<div class="section" id="variables-affecting-the-cpack-cygwin-generator">
<h2>Variables affecting the CPack Cygwin generator<a class="headerlink" href="#variables-affecting-the-cpack-cygwin-generator" title="Permalink to this headline">¶</a></h2>
<ul>
...
<code class="sig-name descname">CPACK_CYGWIN_PATCH_NUMBER</code><a class="headerlink" href="#variable:CPACK_CYGWIN_PATCH_NUMBER" title="Permalink to this definition">¶</a></dt>
<dd><p>The Cygwin patch number.  FIXME: This documentation is incomplete.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_CYGWIN_PATCH_FILE">
<code class="sig-name descname">CPACK_CYGWIN_PATCH_FILE</code><a class="headerlink" href="#variable:CPACK_CYGWIN_PATCH_FILE" title="Permalink to this definition">¶</a></dt>
<dd><p>The Cygwin patch file.  FIXME: This documentation is incomplete.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_CYGWIN_BUILD_SCRIPT">
<code class="sig-name descname">CPACK_CYGWIN_BUILD_SCRIPT</code><a class="headerlink" href="#variable:CPACK_CYGWIN_BUILD_SCRIPT" title="Permalink to this definition">¶</a></dt>
