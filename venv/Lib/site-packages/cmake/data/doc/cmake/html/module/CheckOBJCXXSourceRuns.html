...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckOBJCXXSourceRuns &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CheckPIESupported" href="CheckPIESupported.html" />
    <link rel="prev" title="CheckOBJCXXSourceCompiles" href="CheckOBJCXXSourceCompiles.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CheckPIESupported.html" title="CheckPIESupported"
  ...
  <div class="section" id="checkobjcxxsourceruns">
<span id="module:CheckOBJCXXSourceRuns"></span><h1>CheckOBJCXXSourceRuns<a class="headerlink" href="#checkobjcxxsourceruns" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.16.</span></p>
</div>
<p>Check if given Objective-C++ source compiles and links into an executable and can
subsequently be run.</p>
<dl class="command">
<dt id="command:check_objcxx_source_runs">
<code class="sig-name descname">check_objcxx_source_runs</code><a class="headerlink" href="#command:check_objcxx_source_runs" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_objcxx_source_runs(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
file, linked as an executable and then run. The <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> must contain at
least a <code class="docutils literal notranslate"><span class="pre">main()</span></code> function. If the <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> could be built and run
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_objcxx_source_runs()</span></code>:</p>
<dl class="simple">
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckOBJCXXSourceCompiles.html"
                        title="previous chapter">CheckOBJCXXSourceCompiles</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="CheckPIESupported.html"
                        title="next chapter">CheckPIESupported</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/module/CheckOBJCXXSourceRuns.rst.txt"
