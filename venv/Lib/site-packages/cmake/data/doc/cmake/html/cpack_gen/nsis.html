...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CPack NSIS Generator &mdash; CMake 3.21.0 Documentation</title>
  ...
  <div class="section" id="cpack-nsis-generator">
<span id="cpack_gen:CPack NSIS Generator"></span><h1>CPack NSIS Generator<a class="headerlink" href="#cpack-nsis-generator" title="Permalink to this headline">¶</a></h1>
<p>CPack Nullsoft Scriptable Install System (NSIS) generator specific options.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 3.17: </span>The NSIS generator requires NSIS 3.0 or newer.</p>
</div>
...
<code class="sig-name descname">CPACK_NSIS_INSTALL_ROOT</code><a class="headerlink" href="#variable:CPACK_NSIS_INSTALL_ROOT" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MUI_ICON</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_ICON" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MUI_UNIICON</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_UNIICON" title="Permalink to this definition">¶</a></dt>
<dd><p>An icon filename.  The name of a <code class="docutils literal notranslate"><span class="pre">*.ico</span></code> file used as the main icon for the
...
<code class="sig-name descname">CPACK_NSIS_INSTALLER_MUI_ICON_CODE</code><a class="headerlink" href="#variable:CPACK_NSIS_INSTALLER_MUI_ICON_CODE" title="Permalink to this definition">¶</a></dt>
<dd><p>undocumented.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_MUI_WELCOMEFINISHPAGE_BITMAP">
<code class="sig-name descname">CPACK_NSIS_MUI_WELCOMEFINISHPAGE_BITMAP</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_WELCOMEFINISHPAGE_BITMAP" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MUI_UNWELCOMEFINISHPAGE_BITMAP</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_UNWELCOMEFINISHPAGE_BITMAP" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.5.</span></p>
</div>
...
<code class="sig-name descname">CPACK_NSIS_EXTRA_PREINSTALL_COMMANDS</code><a class="headerlink" href="#variable:CPACK_NSIS_EXTRA_PREINSTALL_COMMANDS" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_EXTRA_INSTALL_COMMANDS</code><a class="headerlink" href="#variable:CPACK_NSIS_EXTRA_INSTALL_COMMANDS" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS</code><a class="headerlink" href="#variable:CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_COMPRESSOR</code><a class="headerlink" href="#variable:CPACK_NSIS_COMPRESSOR" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_ENABLE_UNINSTALL_BEFORE_INSTALL</code><a class="headerlink" href="#variable:CPACK_NSIS_ENABLE_UNINSTALL_BEFORE_INSTALL" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MODIFY_PATH</code><a class="headerlink" href="#variable:CPACK_NSIS_MODIFY_PATH" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_DISPLAY_NAME</code><a class="headerlink" href="#variable:CPACK_NSIS_DISPLAY_NAME" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_PACKAGE_NAME</code><a class="headerlink" href="#variable:CPACK_NSIS_PACKAGE_NAME" title="Permalink to this definition">¶</a></dt>
<dd><p>The title displayed at the top of the installer.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_INSTALLED_ICON_NAME">
<code class="sig-name descname">CPACK_NSIS_INSTALLED_ICON_NAME</code><a class="headerlink" href="#variable:CPACK_NSIS_INSTALLED_ICON_NAME" title="Permalink to this definition">¶</a></dt>
<dd><p>A path to the executable that contains the installer icon.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_HELP_LINK">
<code class="sig-name descname">CPACK_NSIS_HELP_LINK</code><a class="headerlink" href="#variable:CPACK_NSIS_HELP_LINK" title="Permalink to this definition">¶</a></dt>
<dd><p>URL to a web site providing assistance in installing your application.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_URL_INFO_ABOUT">
<code class="sig-name descname">CPACK_NSIS_URL_INFO_ABOUT</code><a class="headerlink" href="#variable:CPACK_NSIS_URL_INFO_ABOUT" title="Permalink to this definition">¶</a></dt>
<dd><p>URL to a web site providing more information about your application.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_CONTACT">
<code class="sig-name descname">CPACK_NSIS_CONTACT</code><a class="headerlink" href="#variable:CPACK_NSIS_CONTACT" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_&lt;compName&gt;_INSTALL_DIRECTORY</code><a class="headerlink" href="#variable:CPACK_NSIS_<compName>_INSTALL_DIRECTORY" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<code class="sig-name descname">CPACK_NSIS_CREATE_ICONS_EXTRA</code><a class="headerlink" href="#variable:CPACK_NSIS_CREATE_ICONS_EXTRA" title="Permalink to this definition">¶</a></dt>
<dd><p>Additional NSIS commands for creating <cite>Start Menu</cite> shortcuts.</p>
</dd></dl>

<dl class="variable">
<dt id="variable:CPACK_NSIS_DELETE_ICONS_EXTRA">
<code class="sig-name descname">CPACK_NSIS_DELETE_ICONS_EXTRA</code><a class="headerlink" href="#variable:CPACK_NSIS_DELETE_ICONS_EXTRA" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_EXECUTABLES_DIRECTORY</code><a class="headerlink" href="#variable:CPACK_NSIS_EXECUTABLES_DIRECTORY" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MUI_FINISHPAGE_RUN</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_FINISHPAGE_RUN" title="Permalink to this definition">¶</a></dt>
...
<code class="sig-name descname">CPACK_NSIS_MENU_LINKS</code><a class="headerlink" href="#variable:CPACK_NSIS_MENU_LINKS" title="Permalink to this definition">¶</a></dt>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_UNINSTALL_NAME">
<code class="sig-name descname">CPACK_NSIS_UNINSTALL_NAME</code><a class="headerlink" href="#variable:CPACK_NSIS_UNINSTALL_NAME" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_WELCOME_TITLE">
<code class="sig-name descname">CPACK_NSIS_WELCOME_TITLE</code><a class="headerlink" href="#variable:CPACK_NSIS_WELCOME_TITLE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.17.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_WELCOME_TITLE_3LINES">
<code class="sig-name descname">CPACK_NSIS_WELCOME_TITLE_3LINES</code><a class="headerlink" href="#variable:CPACK_NSIS_WELCOME_TITLE_3LINES" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.17.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_FINISH_TITLE">
<code class="sig-name descname">CPACK_NSIS_FINISH_TITLE</code><a class="headerlink" href="#variable:CPACK_NSIS_FINISH_TITLE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.17.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_FINISH_TITLE_3LINES">
<code class="sig-name descname">CPACK_NSIS_FINISH_TITLE_3LINES</code><a class="headerlink" href="#variable:CPACK_NSIS_FINISH_TITLE_3LINES" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.17.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_MUI_HEADERIMAGE">
<code class="sig-name descname">CPACK_NSIS_MUI_HEADERIMAGE</code><a class="headerlink" href="#variable:CPACK_NSIS_MUI_HEADERIMAGE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.17.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_MANIFEST_DPI_AWARE">
<code class="sig-name descname">CPACK_NSIS_MANIFEST_DPI_AWARE</code><a class="headerlink" href="#variable:CPACK_NSIS_MANIFEST_DPI_AWARE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_BRANDING_TEXT">
<code class="sig-name descname">CPACK_NSIS_BRANDING_TEXT</code><a class="headerlink" href="#variable:CPACK_NSIS_BRANDING_TEXT" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_BRANDING_TEXT_TRIM_POSITION">
<code class="sig-name descname">CPACK_NSIS_BRANDING_TEXT_TRIM_POSITION</code><a class="headerlink" href="#variable:CPACK_NSIS_BRANDING_TEXT_TRIM_POSITION" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">New in version 3.20.</span></p>
</div>
...
<dl class="variable">
<dt id="variable:CPACK_NSIS_EXECUTABLE">
<code class="sig-name descname">CPACK_NSIS_EXECUTABLE</code><a class="headerlink" href="#variable:CPACK_NSIS_EXECUTABLE" title="Permalink to this definition">¶</a></dt>
<dd><div class="versionadded">
