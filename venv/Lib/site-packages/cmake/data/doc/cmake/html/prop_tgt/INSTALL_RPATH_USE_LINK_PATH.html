...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>INSTALL_RPATH_USE_LINK_PATH &mdash; CMake 3.21.0 Documentation</title>
...
<p><code class="docutils literal notranslate"><span class="pre">INSTALL_RPATH_USE_LINK_PATH</span></code> is a boolean that if set to <code class="docutils literal notranslate"><span class="pre">True</span></code>
...
value of the <span class="target" id="index-0-prop_tgt:INSTALL_RPATH"></span><a class="reference internal" href="INSTALL_RPATH.html#prop_tgt:INSTALL_RPATH" title="INSTALL_RPATH"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">INSTALL_RPATH</span></code></a> target property.</p>
<p>This property is initialized by the value of the variable
<span class="target" id="index-0-variable:CMAKE_INSTALL_RPATH_USE_LINK_PATH"></span><a class="reference internal" href="../variable/CMAKE_INSTALL_RPATH_USE_LINK_PATH.html#variable:CMAKE_INSTALL_RPATH_USE_LINK_PATH" title="CMAKE_INSTALL_RPATH_USE_LINK_PATH"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_INSTALL_RPATH_USE_LINK_PATH</span></code></a> if it is set when a target is
created.</p>
</div>
