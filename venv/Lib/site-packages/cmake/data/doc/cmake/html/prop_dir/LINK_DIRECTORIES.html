...
and is typically populated using the <span class="target" id="index-0-command:link_directories"></span><a class="reference internal" href="../command/link_directories.html#command:link_directories" title="link_directories"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">link_directories()</span></code></a> command.
It gets its initial value from its parent directory, if it has one.</p>
<p>The directory property is used to initialize the <span class="target" id="index-0-prop_tgt:LINK_DIRECTORIES"></span><a class="reference internal" href="../prop_tgt/LINK_DIRECTORIES.html#prop_tgt:LINK_DIRECTORIES" title="LINK_DIRECTORIES"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">LINK_DIRECTORIES</span></code></a>
target property when a target is created.  That target property is used
by the generators to set the library search directories for the linker.</p>
<p>Contents of <code class="docutils literal notranslate"><span class="pre">LINK_DIRECTORIES</span></code> may use &quot;generator expressions&quot; with
