...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>FindPackageHandleStandardArgs &mdash; CMake 3.21.0 Documentation</title>
...
<code class="sig-name descname">find_package_handle_standard_args</code><a class="headerlink" href="#command:find_package_handle_standard_args" title="Permalink to this definition">¶</a></dt>
...
message.</p>
<dl class="command">
<dt id="command:find_package_check_version">
<code class="sig-name descname">find_package_check_version</code><a class="headerlink" href="#command:find_package_check_version" title="Permalink to this definition">¶</a></dt>
