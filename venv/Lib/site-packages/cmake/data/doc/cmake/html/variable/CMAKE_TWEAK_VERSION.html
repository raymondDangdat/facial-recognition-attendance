...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_TWEAK_VERSION &mdash; CMake 3.21.0 Documentation</title>
...
<p>Defined to <code class="docutils literal notranslate"><span class="pre">0</span></code> for compatibility with code written for older
CMake versions that may have defined higher values.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>In CMake versions 2.8.2 through 2.8.12, this variable holds
the fourth version number component of the
<span class="target" id="index-0-variable:CMAKE_VERSION"></span><a class="reference internal" href="CMAKE_VERSION.html#variable:CMAKE_VERSION" title="CMAKE_VERSION"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_VERSION</span></code></a> variable.</p>
</div>
</div>
