...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckFortranSourceCompiles &mdash; CMake 3.21.0 Documentation</title>
...
<dl class="command">
<dt id="command:check_fortran_source_compiles">
<code class="sig-name descname">check_fortran_source_compiles</code><a class="headerlink" href="#command:check_fortran_source_compiles" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_fortran_source_compiles(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
<span class="w">    </span><span class="p">[</span><span class="no">FAIL_REGEX</span><span class="w"> </span><span class="nv">&lt;regex&gt;...</span><span class="p">]</span><span class="w"></span>
<span class="w">    </span><span class="p">[</span><span class="no">SRC_EXT</span><span class="w"> </span><span class="nv">&lt;extension&gt;</span><span class="p">]</span><span class="w"></span>
...
source file and linked as an executable. The <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> must be a Fortran program
containing at least an <code class="docutils literal notranslate"><span class="pre">end</span></code> statement--for example:</p>
<div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_fortran_source_compiles(</span><span class="s">&quot;character :: b; error stop b; end&quot;</span><span class="w"> </span><span class="no">F2018ESTOPOK</span><span class="w"> </span><span class="no">SRC_EXT</span><span class="w"> </span><span class="no">F90</span><span class="nf">)</span><span class="w"></span>
</pre></div>
</div>
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_fortran_source_compiles()</span></code>:</p>
<dl>
