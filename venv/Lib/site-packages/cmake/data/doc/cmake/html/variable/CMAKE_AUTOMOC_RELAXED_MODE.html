...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_AUTOMOC_RELAXED_MODE &mdash; CMake 3.21.0 Documentation</title>
...
<p><span class="versionmodified deprecated">Deprecated since version 3.15.</span></p>
</div>
<p>Switch between strict and relaxed automoc mode.</p>
<p>By default, <span class="target" id="index-0-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a> behaves exactly as described in the
documentation of the <span class="target" id="index-1-prop_tgt:AUTOMOC"></span><a class="reference internal" href="../prop_tgt/AUTOMOC.html#prop_tgt:AUTOMOC" title="AUTOMOC"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">AUTOMOC</span></code></a> target property.  When set to
<code class="docutils literal notranslate"><span class="pre">TRUE</span></code>, it accepts more input and tries to find the correct input file for
<code class="docutils literal notranslate"><span class="pre">moc</span></code> even if it differs from the documented behavior.  In this mode it
e.g.  also checks whether a header file is intended to be processed by moc
when a <code class="docutils literal notranslate"><span class="pre">&quot;foo.moc&quot;</span></code> file has been included.</p>
