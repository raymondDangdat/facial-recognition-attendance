...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckCSourceCompiles &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CheckCompilerFlag" href="CheckCompilerFlag.html" />
...
<dl class="command">
<dt id="command:check_c_source_compiles">
<code class="sig-name descname">check_c_source_compiles</code><a class="headerlink" href="#command:check_c_source_compiles" title="Permalink to this definition">¶</a></dt>
<dd><div class="highlight-cmake notranslate"><div class="highlight"><pre><span></span><span class="nf">check_c_source_compiles(</span><span class="nv">&lt;code&gt;</span><span class="w"> </span><span class="nv">&lt;resultVar&gt;</span><span class="w"></span>
...
<p>Check that the source supplied in <code class="docutils literal notranslate"><span class="pre">&lt;code&gt;</span></code> can be compiled as a C source
...
variables prior to calling <code class="docutils literal notranslate"><span class="pre">check_c_source_compiles()</span></code>:</p>
<dl>
...
<code class="docutils literal notranslate"><span class="pre">&lt;resultVar&gt;</span></code> must be manually removed from the cache.</p>
  ...
  <p class="topless"><a href="CheckCompilerFlag.html"
                        title="previous chapter">CheckCompilerFlag</a></p>
  <h4>Next topic</h4>
