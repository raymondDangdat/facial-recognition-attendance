...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_MACOSX_BUNDLE &mdash; CMake 3.21.0 Documentation</title>
...
<p>Default value for <span class="target" id="index-0-prop_tgt:MACOSX_BUNDLE"></span><a class="reference internal" href="../prop_tgt/MACOSX_BUNDLE.html#prop_tgt:MACOSX_BUNDLE" title="MACOSX_BUNDLE"><code class="xref cmake cmake-prop_tgt docutils literal notranslate"><span class="pre">MACOSX_BUNDLE</span></code></a> of targets.</p>
...
<p>This variable is set to <code class="docutils literal notranslate"><span class="pre">ON</span></code> by default if <span class="target" id="index-0-variable:CMAKE_SYSTEM_NAME"></span><a class="reference internal" href="CMAKE_SYSTEM_NAME.html#variable:CMAKE_SYSTEM_NAME" title="CMAKE_SYSTEM_NAME"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_SYSTEM_NAME</span></code></a>
equals to <a class="reference internal" href="../manual/cmake-toolchains.7.html#cross-compiling-for-ios-tvos-or-watchos"><span class="std std-ref">iOS, tvOS or watchOS</span></a>.</p>
</div>
