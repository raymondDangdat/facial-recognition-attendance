...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_NETRC_FILE &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="prev" title="CMAKE_NETRC" href="CMAKE_NETRC.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_NETRC.html" title="CMAKE_NETRC"
  ...
  <div class="section" id="cmake-netrc-file">
<span id="variable:CMAKE_NETRC_FILE"></span><h1>CMAKE_NETRC_FILE<a class="headerlink" href="#cmake-netrc-file" title="Permalink to this headline">¶</a></h1>
<div class="versionadded">
<p><span class="versionmodified added">New in version 3.11.</span></p>
</div>
<p>This variable is used to initialize the <code class="docutils literal notranslate"><span class="pre">NETRC_FILE</span></code> option for
<span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(DOWNLOAD)</span></code></a> and <span class="target" id="index-1-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(UPLOAD)</span></code></a> commands and the
module <span class="target" id="index-0-module:ExternalProject"></span><a class="reference internal" href="../module/ExternalProject.html#module:ExternalProject" title="ExternalProject"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">ExternalProject</span></code></a>. See those commands for additional
information.</p>
<p>The local option takes precedence over this variable.</p>
</div>
  ...
  <p class="topless"><a href="CMAKE_NETRC.html"
                        title="previous chapter">CMAKE_NETRC</a></p>
  <h4>Next topic</h4>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/variable/CMAKE_NETRC_FILE.rst.txt"
