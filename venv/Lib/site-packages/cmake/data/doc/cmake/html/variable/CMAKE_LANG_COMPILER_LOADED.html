...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMAKE_&lt;LANG&gt;_COMPILER_LOADED &mdash; CMake 3.21.0 Documentation</title>
    ...
    <link rel="next" title="CMAKE_&lt;LANG&gt;_COMPILER_PREDEFINES_COMMAND" href="CMAKE_LANG_COMPILER_PREDEFINES_COMMAND.html" />
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="CMAKE_LANG_COMPILER_PREDEFINES_COMMAND.html" title="CMAKE_&lt;LANG&gt;_COMPILER_PREDEFINES_COMMAND"
...
<p>When language <code class="docutils literal notranslate"><span class="pre">&lt;LANG&gt;</span></code> is enabled by <span class="target" id="index-0-command:project"></span><a class="reference internal" href="../command/project.html#command:project" title="project"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">project()</span></code></a> or
<span class="target" id="index-0-command:enable_language"></span><a class="reference internal" href="../command/enable_language.html#command:enable_language" title="enable_language"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">enable_language()</span></code></a> this variable is defined to <code class="docutils literal notranslate"><span class="pre">1</span></code>.</p>
</div>
  ...
  <h4>Next topic</h4>
  <p class="topless"><a href="CMAKE_LANG_COMPILER_PREDEFINES_COMMAND.html"
                        title="next chapter">CMAKE_&lt;LANG&gt;_COMPILER_PREDEFINES_COMMAND</a></p>
